function LoadFSGraph_EditFS(fs_name)
{
	...
	/*****************************************************************************/
	  ...
	  obj_ost_pie_space = JSON.parse(JSON.stringify(chartConfig_Pie_DB));
			obj_ost_pie_space.title.text= fs_name + " Space Usage";
			...
			starttime: "", filesystem: fs_name, endtime: ""})
	...
	var free=0,used=0;
	  ...
	  obj_ost_pie_inode = JSON.parse(JSON.stringify(chartConfig_Pie_DB));
			obj_ost_pie_inode.title.text= fs_name + " - Files vs Free Files";
