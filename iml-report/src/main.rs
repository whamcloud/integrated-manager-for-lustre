...
use iml_report::{Errors, Incoming, ReportSenders};
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let addr = iml_manager_env::get_report_addr();
    let report_path = iml_manager_env::get_report_path();
