...
use components::{
    breadcrumbs, command_modal, date_view, font_awesome, font_awesome_outline, loading, restrict, stratagem, tree,
...
fn after_mount(url: Url, orders: &mut impl Orders<Msg, GMsg>) -> AfterMount<Model> {
    ...
    AfterMount::new(Model {
        ...
        server_date: date_view::Model::default(),
    })
}
