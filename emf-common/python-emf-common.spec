...
Release:    1%{?dist}
# Release End
Summary:        Common library used by multiple EMF components
License:        MIT
...
%description
A Python package that contains common components for the EMF project Different
areas of the EMF project utilise common code that is shared distributed through
this package.This packaging intends to improve code reuse and componentization
within the EMF project.

%package -n     python2-%{rpm_name}
Summary:        %{summary}
%{?python_provide:%python_provide python2-%{rpm_name}}
Obsoletes:       python2-iml-common1.0 python2-iml-common1.1
Obsoletes:       python2-iml-common1.2 python2-iml-common1.3
Obsoletes:       python2-iml-common1.4
Provides: python2-iml-common%{major_minor}
Obsoletes: python2-iml-common%{major_minor}
