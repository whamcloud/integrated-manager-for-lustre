...
""" % ", ".join(
    ...
    if ns.action == "metadata":
        print(
            """<?xml version="1.0" ?>
<resource-agent name="fence_chroma" shortdesc="Fence agent for EXAScaler Management Framework software Storage Servers">
<longdesc>fence_chroma is an I/O Fencing agent which can be used with EXAScaler Management Framework software Storage Servers.</longdesc>
