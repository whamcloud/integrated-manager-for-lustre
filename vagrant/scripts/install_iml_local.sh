...
cp /integrated-manager-for-lustre/_topdir/RPMS/x86_64/rust-iml-{action-runner,cli,ostpool,agent-comms,mailbox,postoffice,warp-drive}-*.rpm /tmp/manager-rpms/
