...
cp /tmp/iml/_topdir/RPMS/rust-iml-{action-runner,agent-comms,api,cli,client,corosync,config-cli,journal,mailbox,ntp,ostpool,postoffice,report,sfa,snapshot,stats,task-runner,device,warp-drive,timer}-*.rpm /tmp/manager-rpms/
