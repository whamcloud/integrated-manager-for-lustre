...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        config = {
            ...
            "EMF_API_PORT": settings.EMF_API_PORT,
            "EMF_API_PROXY_PASS": settings.EMF_API_PROXY_PASS,
            ...
            "INFLUXDB_EMF_DB": settings.INFLUXDB_EMF_DB,
            "INFLUXDB_STRATAGEM_SCAN_DB": settings.INFLUXDB_STRATAGEM_SCAN_DB,
            "INFLUXDB_EMF_STATS_DB": settings.INFLUXDB_EMF_STATS_DB,
            "INFLUXDB_EMF_STATS_LONG_DURATION": settings.INFLUXDB_EMF_STATS_LONG_DURATION,
