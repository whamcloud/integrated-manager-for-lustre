...
class Device(models.Model):
    id = models.CharField(help_text=b"Unique identifer per-device", max_length=255, primary_key=True, serialize=False)
    ...
    parents = django.contrib.postgres.fields.ArrayField(
        base_field=models.CharField(max_length=255), help_text=b"", size=None
    )
    children = django.contrib.postgres.fields.ArrayField(
        base_field=models.CharField(max_length=255), help_text=b"", size=None
    )
    max_depth = models.SmallIntegerField(default=0, help_text=b"")
...
class DeviceHost(models.Model):
    ...
    paths = django.contrib.postgres.fields.ArrayField(
        base_field=models.CharField(max_length=255), help_text=b"", size=None
    )
