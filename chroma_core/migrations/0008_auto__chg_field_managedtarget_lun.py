...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ManagedTarget.lun'
        db.alter_column('chroma_core_managedtarget', 'lun_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['chroma_core.Lun']))


    def backwards(self, orm):
        
        # Changing field 'ManagedTarget.lun'
        db.alter_column('chroma_core_managedtarget', 'lun_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chroma_core.Lun'], null=True))
