...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Volume.usable_for_lustre'
        db.add_column('chroma_core_volume', 'usable_for_lustre',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Volume.usable_for_lustre'
        db.delete_column('chroma_core_volume', 'usable_for_lustre')
    ...
    models = {
        ...
        'chroma_core.registrationtoken': {
            ...
            'expiry': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 10, 5, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['chroma_core.ServerProfile']", 'null': 'True'}),
            'secret': ('django.db.models.fields.CharField', [], {'default': "'E1124AAE08767AB4BDDD72906A43B0F3'", 'max_length': '32'})
        },
