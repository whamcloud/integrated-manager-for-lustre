# -*- coding: utf-8 -*-
# Generated by Django 1.11.23 on 2019-11-04 17:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filesystem', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='chroma_core.ManagedFilesystem')),
                ('osts', models.ManyToManyField(help_text=b'OST list in this Pool', to='chroma_core.ManagedOst')),
            ],
        ),
        migrations.CreateModel(
