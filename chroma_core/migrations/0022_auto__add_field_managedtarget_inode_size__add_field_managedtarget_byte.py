...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ManagedTarget.inode_size'
        db.add_column('chroma_core_managedtarget', 'inode_size', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'ManagedTarget.bytes_per_inode'
        db.add_column('chroma_core_managedtarget', 'bytes_per_inode', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'ManagedTarget.inode_count'
        db.add_column('chroma_core_managedtarget', 'inode_count', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ManagedTarget.inode_size'
        db.delete_column('chroma_core_managedtarget', 'inode_size')

        # Deleting field 'ManagedTarget.bytes_per_inode'
        db.delete_column('chroma_core_managedtarget', 'bytes_per_inode')

        # Deleting field 'ManagedTarget.inode_count'
        db.delete_column('chroma_core_managedtarget', 'inode_count')
    ...
    models = {
        'chroma_core.agentsession': {
            ...
            'session_id': ('django.db.models.fields.CharField', [], {'default': "'25577c62'", 'max_length': '8'})
        },
