...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('chroma_core_agentsession', (
            ...
            ('session_id', self.gf('django.db.models.fields.CharField')(default='b4eea56f', max_length=8)),
    ...
    models = {
        'chroma_core.agentsession': {
            ...
            'session_id': ('django.db.models.fields.CharField', [], {'default': "'853095a2'", 'max_length': '8'})
        },
