...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ManagedTarget.state_modified_at'
        db.add_column('chroma_core_managedtarget', 'state_modified_at', self.gf('chroma_core.models.utils.WorkaroundDateTimeField')(default=datetime.datetime(2012, 4, 1, 19, 4, 45, 978475)), keep_default=False)

        # Adding field 'ManagedFilesystem.state_modified_at'
        db.add_column('chroma_core_managedfilesystem', 'state_modified_at', self.gf('chroma_core.models.utils.WorkaroundDateTimeField')(default=datetime.datetime(2012, 4, 1, 19, 4, 54, 186446)), keep_default=False)

        # Adding field 'ManagedHost.state_modified_at'
        db.add_column('chroma_core_managedhost', 'state_modified_at', self.gf('chroma_core.models.utils.WorkaroundDateTimeField')(default=datetime.datetime(2012, 4, 1, 19, 4, 55, 706871)), keep_default=False)

        # Adding field 'LNetConfiguration.state_modified_at'
        db.add_column('chroma_core_lnetconfiguration', 'state_modified_at', self.gf('chroma_core.models.utils.WorkaroundDateTimeField')(default=datetime.datetime(2012, 4, 1, 19, 4, 56, 834334)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ManagedTarget.state_modified_at'
        db.delete_column('chroma_core_managedtarget', 'state_modified_at')

        # Deleting field 'ManagedFilesystem.state_modified_at'
        db.delete_column('chroma_core_managedfilesystem', 'state_modified_at')

        # Deleting field 'ManagedHost.state_modified_at'
        db.delete_column('chroma_core_managedhost', 'state_modified_at')
    ...
    models = {
        'chroma_core.agentsession': {
            ...
            'session_id': ('django.db.models.fields.CharField', [], {'default': "'c0d7d948'", 'max_length': '8'})
        },
