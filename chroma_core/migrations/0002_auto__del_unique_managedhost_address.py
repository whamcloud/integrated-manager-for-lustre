...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'ManagedHost', fields ['address']
        db.delete_unique('configure_managedhost', ['address'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'ManagedHost', fields ['address']
        db.create_unique('configure_managedhost', ['address'])
