...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('chroma_core_lun', 'chroma_core_volume')
        db.rename_table('chroma_core_lunnode', 'chroma_core_volumenode')

        db.drop_foreign_key('chroma_core_volumenode', 'lun_id')
        db.rename_column('chroma_core_volumenode', 'lun_id', 'volume_id')
        db.alter_column('chroma_core_volumenode', 'volume_id', models.ForeignKey(to = orm['chroma_core.Volume']))

        db.drop_foreign_key('chroma_core_managedtarget', 'lun_id')
        db.rename_column('chroma_core_managedtarget', 'lun_id', 'volume_id')
        db.alter_column('chroma_core_managedtarget', 'volume_id', models.ForeignKey(to = orm['chroma_core.Volume']))

        db.drop_foreign_key('chroma_core_managedtargetmount', 'block_device_id')
        db.rename_column('chroma_core_managedtargetmount', 'block_device_id', 'volume_node_id')
        db.alter_column('chroma_core_managedtargetmount', 'volume_node_id', models.ForeignKey(to = orm['chroma_core.VolumeNode']))

    def backwards(self, orm):
        db.drop_foreign_key('chroma_core_managedtargetmount', 'volume_node_id')
        db.rename_column('chroma_core_managedtargetmount', 'volume_node_id', 'block_device_id')
        db.alter_column('chroma_core_managedtargetmount', 'block_device_id_id', models.ForeignKey(to = orm['chroma_core.VolumeNode']))

        db.drop_foreign_key('chroma_core_volumenode', 'volume_id')
        db.rename_column('chroma_core_volumenode', 'volume_id', 'lun_id')
        db.alter_column('chroma_core_volumenode', 'lun_id', models.ForeignKey(to = orm['chroma_core.Lun']))

        db.drop_foreign_key('chroma_core_managedtarget', 'volume_id')
        db.rename_column('chroma_core_managedtarget', 'volume_id', 'lun_id')
        db.alter_column('chroma_core_managedtarget', 'lun_id', models.ForeignKey(to = orm['chroma_core.Lun']))

        db.rename_table('chroma_core_volumenode', 'chroma_core_lunnode')
        db.rename_table('chroma_core_volume', 'chroma_core_lun')
    ...
    models = {
        'chroma_core.agentsession': {
            ...
            'session_id': ('django.db.models.fields.CharField', [], {'default': "'0e62a76d'", 'max_length': '8'})
        },
        ...
        'chroma_core.removeunconfiguredhostjob': {
            'Meta': {'object_name': 'RemoveUnconfiguredHostJob', '_ormbases': ['chroma_core.Job']},
            'host': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['chroma_core.ManagedHost']"}),
            'job_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['chroma_core.Job']", 'unique': 'True', 'primary_key': 'True'})
        },
