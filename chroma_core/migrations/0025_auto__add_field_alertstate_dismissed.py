...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AlertState.dismissed'
        db.add_column('chroma_core_alertstate', 'dismissed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AlertState.dismissed'
        db.delete_column('chroma_core_alertstate', 'dismissed')
    ...
    models = {
        'chroma_core.agentsession': {
            ...
            'session_id': ('django.db.models.fields.CharField', [], {'default': "'9289edda'", 'max_length': '8'})
        },
