...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'StorageResourceAttribute.value'
        db.delete_column('chroma_core_storageresourceattribute', 'value')


    def backwards(self, orm):
        
        # Adding field 'StorageResourceAttribute.value'
        db.add_column('chroma_core_storageresourceattribute', 'value', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)
    ...
    models = {
        'chroma_core.agentsession': {
            ...
            'session_id': ('django.db.models.fields.CharField', [], {'default': "'c7fda8fd'", 'max_length': '8'})
        },
