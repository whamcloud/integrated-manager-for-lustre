...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ManagedTarget.lun'
        db.add_column('chroma_core_managedtarget', 'lun', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chroma_core.Lun'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ManagedTarget.lun'
        db.delete_column('chroma_core_managedtarget', 'lun_id')
