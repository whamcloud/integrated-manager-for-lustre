...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TestHostConnectionJob'
        db.create_table('chroma_core_testhostconnectionjob', (
            ...
            ('credentials_key', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('chroma_core', ['TestHostConnectionJob'])

        # Adding field 'StepResult.result'
        db.add_column('chroma_core_stepresult', 'result',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'TestHostConnectionJob'
        db.delete_table('chroma_core_testhostconnectionjob')

        # Deleting field 'StepResult.result'
        db.delete_column('chroma_core_stepresult', 'result')
    ...
    models = {
        ...
        'chroma_core.registrationtoken': {
            ...
            'expiry': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 13, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['chroma_core.ServerProfile']", 'null': 'True'}),
            'secret': ('django.db.models.fields.CharField', [], {'default': "'8A4D03C872190DCA4BCD7A0703D094CF'", 'max_length': '32'})
        },
