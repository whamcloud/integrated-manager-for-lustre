# -*- coding: utf-8 -*-
# Generated by Django 1.11.27 on 2020-08-26 12:57
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "ha_label",
                    models.CharField(
                        help_text=b"Set if there is a single resource that will controll entire hotpools configuration",
                        max_length=64,
                        null=True,
                    ),
                ),
        ...
        migrations.AlterField(
            ...
            name="name",
            field=models.CharField(help_text=b"Snapshot to create", max_length=64),
        ),
        migrations.AlterField(
            model_name="destroysnapshotjob",
            name="name",
            field=models.CharField(help_text=b"Snapshot to destroy", max_length=64),
        ),
        migrations.AddField(
            model_name="lpurge",
            name="configuration",
