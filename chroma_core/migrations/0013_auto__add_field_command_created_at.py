...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Command.created_at'
        db.add_column('chroma_core_command', 'created_at', self.gf('chroma_core.models.utils.WorkaroundDateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 2, 23, 16, 51, 22, 198859), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Command.created_at'
        db.delete_column('chroma_core_command', 'created_at')
