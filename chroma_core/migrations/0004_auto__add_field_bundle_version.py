...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bundle.version'
        db.add_column('chroma_core_bundle', 'version',
                      self.gf('django.db.models.fields.CharField')(default='0.0.0', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bundle.version'
        db.delete_column('chroma_core_bundle', 'version')
    ...
    models = {
        ...
        'chroma_core.registrationtoken': {
            ...
            'expiry': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 20, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['chroma_core.ServerProfile']", 'null': 'True'}),
            'secret': ('django.db.models.fields.CharField', [], {'default': "'48D2E7BD67FA745F19E5E50C34D89DED'", 'max_length': '32'})
        },
