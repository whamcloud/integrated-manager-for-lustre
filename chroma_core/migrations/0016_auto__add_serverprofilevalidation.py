...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ServerProfileValidation'
        db.create_table('chroma_core_serverprofilevalidation', (
        ...
        db.send_create_signal('chroma_core', ['ServerProfileValidation'])


    def backwards(self, orm):
        # Deleting model 'ServerProfileValidation'
        db.delete_table('chroma_core_serverprofilevalidation')
    ...
    models = {
        ...
        'chroma_core.registrationtoken': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'D4CED90E73776D2EA0B4B0CF3E5B465E'", 'max_length': '32'})
        },
