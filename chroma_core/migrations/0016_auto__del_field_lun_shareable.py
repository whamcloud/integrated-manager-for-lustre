...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Lun.shareable'
        db.delete_column('chroma_core_lun', 'shareable')


    def backwards(self, orm):
        
        # Adding field 'Lun.shareable'
        db.add_column('chroma_core_lun', 'shareable', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    models = {
        'chroma_core.agentsession': {
            ...
            'session_id': ('django.db.models.fields.CharField', [], {'default': "'5d5fcab2'", 'max_length': '8'})
        },
