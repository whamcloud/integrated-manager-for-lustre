...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for pct in orm.PowerControlType.objects.all():
            if pct.default_options is None:
                pct.default_options = ""
                pct.save()
    ...
    models = {
        ...
        'chroma_core.registrationtoken': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'DC9B886DB364427865DC32B6AA5DFBAE'", 'max_length': '32'})
        },
