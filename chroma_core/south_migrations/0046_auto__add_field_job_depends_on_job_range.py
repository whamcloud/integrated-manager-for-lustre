...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Job.depends_on_job_range'
        db.add_column(u'chroma_core_job', 'depends_on_job_range',
                      self.gf('django.db.models.fields.CharField')(default='[]', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Job.depends_on_job_range'
        db.delete_column(u'chroma_core_job', 'depends_on_job_range')
    ...
    models = {
        ...
        'chroma_core.job': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']", 'null': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'depends_on_job_range': ('django.db.models.fields.CharField', [], {'default': "'[]'", 'max_length': '64'}),
            'errored': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'chroma_core.registrationtoken': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'13072302240E1A46F8B255EE08D269CD'", 'max_length': '32'})
        },
