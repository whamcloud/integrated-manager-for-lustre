...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('chroma_core_networkinterface', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('host', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chroma_core.ManagedHost'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('inet4_address', self.gf('django.db.models.fields.CharField')(max_length=128)),
        ...
        db.send_create_signal('chroma_core', ['NetworkInterface'])
        ...
        db.send_create_signal('chroma_core', ['UpdateDevicesJob'])

        # Deleting field 'Nid.nid_string'
        db.delete_column('chroma_core_nid', 'nid_string')

        # Deleting field 'Nid.id'
        db.delete_column('chroma_core_nid', 'id')

        # Adding field 'Nid.network_interface'
        db.add_column('chroma_core_nid', 'network_interface',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=0, to=orm['chroma_core.NetworkInterface'], unique=True, primary_key=True),
                      keep_default=False)

        # Adding field 'Nid.lnd_network'
        db.add_column('chroma_core_nid', 'lnd_network',
        ...
        db.add_column('chroma_core_configurelnetjob', 'config_changes',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=4096),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table('chroma_core_networkinterface')
        ...
        # Adding field 'Nid.id'
        db.add_column('chroma_core_nid', 'id',
                      self.gf('django.db.models.fields.AutoField')(default=0, primary_key=True),
                      keep_default=False)

        # Deleting field 'Nid.network_interface'
        db.delete_column('chroma_core_nid', 'network_interface_id')
        ...
        db.add_column('chroma_core_configurelnetjob', 'old_state',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=32),
                      keep_default=False)

        # Adding field 'ConfigureLNetJob.lnet_configuration'
        db.add_column('chroma_core_configurelnetjob', 'lnet_configuration',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['chroma_core.LNetConfiguration']),
                      keep_default=False)

        # Deleting field 'ConfigureLNetJob.host'
        db.delete_column('chroma_core_configurelnetjob', 'host_id')

        # Deleting field 'ConfigureLNetJob.config_changes'
        db.delete_column('chroma_core_configurelnetjob', 'config_changes')
    ...
    models = {
        ...
        'chroma_core.registrationtoken': {
            ...
            'expiry': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 7, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['chroma_core.ServerProfile']", 'null': 'True'}),
            'secret': ('django.db.models.fields.CharField', [], {'default': "'C8C227FB5315EED7642DB8A5034784D3'", 'max_length': '32'})
        },
