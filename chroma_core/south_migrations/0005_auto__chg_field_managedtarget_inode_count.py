...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ManagedTarget.inode_count'
        db.alter_column('chroma_core_managedtarget', 'inode_count', self.gf('django.db.models.fields.BigIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'ManagedTarget.inode_count'
        db.alter_column('chroma_core_managedtarget', 'inode_count', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        'chroma_core.registrationtoken': {
            ...
            'expiry': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 14, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['chroma_core.ServerProfile']", 'null': 'True'}),
            'secret': ('django.db.models.fields.CharField', [], {'default': "'169BEEA415DDF0ACAB978065746F649C'", 'max_length': '32'})
        },
