...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Changing field 'PowerControlType.default_options'
        db.alter_column(u'chroma_core_powercontroltype', 'default_options', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):
        # Adding model 'PackageVersion'
        db.create_table(u'chroma_core_packageversion', (
        ...
        db.create_unique(u'chroma_core_packageversion', ['package_id', 'version', 'release'])

        # Adding model 'PackageInstallation'
        db.create_table(u'chroma_core_packageinstallation', (
        ...
        db.create_unique(u'chroma_core_packageinstallation', ['package_version_id', 'host_id'])

        # Adding model 'PackageAvailability'
        db.create_table(u'chroma_core_packageavailability', (
            ('host', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chroma_core.ManagedHost'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('package_version', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chroma_core.PackageVersion'])),
        ))
        ...
        db.create_unique(u'chroma_core_packageavailability', ['package_version_id', 'host_id'])

        # Adding model 'Package'
        db.create_table(u'chroma_core_package', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        # Changing field 'PowerControlType.default_options'
        db.alter_column(u'chroma_core_powercontroltype', 'default_options', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
    ...
    models = {
        ...
        'chroma_core.registrationtoken': {
            ...
            'expiry': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2019, 1, 17, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['chroma_core.ServerProfile']", 'null': 'True'}),
            'secret': ('django.db.models.fields.CharField', [], {'default': "'103AE70524952622EB38C8CC10936907'", 'max_length': '32'})
        },
