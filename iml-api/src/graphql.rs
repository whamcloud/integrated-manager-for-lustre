...
impl MutationRoot {
    ...
    #[graphql(arguments(
        ...
        reserve_value(description = "The amount of percent of free space to reserve"),
        reserve_unit(description = "Unit of measurement of free space to reserve"),
        keep_num(
            description = "The minimum number of snapshots to keep. This is to avoid deleting all snapshot while pursuiting the reserve goal"
        )
    ))]
