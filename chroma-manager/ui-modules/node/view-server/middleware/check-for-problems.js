...
exports.wiretree = function checkForProblemsFactory (logger, getStoppedSupervisorServices, format,
                                                     renderRequestError) {
  /**
   * Checks if supervisor and all it's services are running.
   * @param {Object} req
   * @param {Object} res
   * @param {Function} next
   */
  return function checkForProblems (req, res, next) {
