...
(function () {
  ...
  angular.module('dashboard').controller('MdtDashboardCtrl', ['$scope', 'streams', 'dashboardPath', MdtDashboardCtrl]);

  /**
   * The dashboard page for a mdt
   * @param {Object} $scope
   * @param {Object} streams
   * @param {Object} dashboardPath
   * @constructor
   */
  function MdtDashboardCtrl($scope, streams, dashboardPath) {
    $scope.dashboard = {
      mdt: {},
      usage: {},
      charts: [
    ...
    var targetStream = streams.targetStream('dashboard.mdt', $scope);
