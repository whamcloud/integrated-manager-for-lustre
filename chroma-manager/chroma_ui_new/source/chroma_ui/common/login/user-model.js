...
angular.module('login')
   ...
   * @name UserModel
   */
  .factory('UserModel', ['resourceful', 'user_EULA_STATES', function (resourceful, EULA_STATES) {
    'use strict';

    return resourceful('user/:id', {
      defaultParams: {id: '@id'},
      instanceMethods: {
        actOnEulaState: function (showFunc, denyFunc, passFunc) {
