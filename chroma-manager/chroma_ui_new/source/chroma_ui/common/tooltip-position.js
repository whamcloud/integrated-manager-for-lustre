...
(function () {
  ...
  /**
   * Helper class, responsible for positioning tooltips.
   * @constructor
   */
  function TooltipPosition($window) {
    this.$window = $window;
  ...
  TooltipPosition.prototype.positioner = function (element) {
  ...
  TooltipPosition.prototype.position = function (direction, tooltipPositioner) {
    return this.defaults[direction].position(tooltipPositioner);
  };

  TooltipPosition.prototype.overflows = function (direction, windowPositioner, tooltipPositioner) {
  ...
  angular.module('tooltipPosition', [])
    .service('tooltipPosition', ['$window', TooltipPosition]);
}());
