...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ServerProfile.default'
        db.add_column('chroma_core_serverprofile', 'default',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding unique constraint on 'ServerProfile', fields ['default']
        db.create_unique('chroma_core_serverprofile', ['default'])

        # Adding field 'ManagedHost.needs_update'
        db.add_column('chroma_core_managedhost', 'needs_update',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'UpdateJob.host_ids'
        db.delete_column('chroma_core_updatejob', 'host_ids')

        # Adding field 'UpdateJob.host'
        db.add_column('chroma_core_updatejob', 'host',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['chroma_core.ManagedHost']),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'ServerProfile', fields ['default']
        db.delete_unique('chroma_core_serverprofile', ['default'])
        ...
        # Deleting field 'ServerProfile.default'
        db.delete_column('chroma_core_serverprofile', 'default')

        # Deleting field 'ManagedHost.needs_update'
        db.delete_column('chroma_core_managedhost', 'needs_update')

        # Adding field 'UpdateJob.host_ids'
        db.add_column('chroma_core_updatejob', 'host_ids',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512),
                      keep_default=False)

        # Deleting field 'UpdateJob.host'
        db.delete_column('chroma_core_updatejob', 'host_id')
    ...
    models = {
        ...
        'chroma_core.registrationtoken': {
            ...
            'expiry': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 21, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['chroma_core.ServerProfile']", 'null': 'True'}),
            'secret': ('django.db.models.fields.CharField', [], {'default': "'E4E9B6EE8D30E92FA8F49EAC0D5D874B'", 'max_length': '32'})
        },
        ...
        'chroma_core.serverprofile': {
            'Meta': {'unique_together': "(('name',), ('default',))", 'object_name': 'ServerProfile'},
