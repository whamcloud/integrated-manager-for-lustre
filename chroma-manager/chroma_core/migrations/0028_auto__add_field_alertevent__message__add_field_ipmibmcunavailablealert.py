...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AlertEvent._message'
        db.add_column('chroma_core_alertstate', '_message',
                      self.gf('django.db.models.fields.TextField')(null=True, db_column='message'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AlertEvent._message'
        db.delete_column('chroma_core_alertstate', 'message')
    ...
    models = {
        ...
        'chroma_core.registrationtoken': {
            ...
            'expiry': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 3, 29, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['chroma_core.ServerProfile']", 'null': 'True'}),
            'secret': ('django.db.models.fields.CharField', [], {'default': "'075A07F91D7978BCD302A6966F2CD7C4'", 'max_length': '32'})
        },
