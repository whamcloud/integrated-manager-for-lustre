...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IpmiBmcUnavailableAlert'
        db.create_table('chroma_core_ipmibmcunavailablealert', (
        ...
        db.send_create_signal('chroma_core', ['IpmiBmcUnavailableAlert'])


    def backwards(self, orm):
        # Deleting model 'IpmiBmcUnavailableAlert'
    ...
    models = {
        ...
        'chroma_core.registrationtoken': {
            ...
            'expiry': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 9, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['chroma_core.ServerProfile']", 'null': 'True'}),
            'secret': ('django.db.models.fields.CharField', [], {'default': "'3E0448442CE529574127E8B444CB3479'", 'max_length': '32'})
        },
