...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ManagedHost.install_method'
        db.add_column('chroma_core_managedhost', 'install_method',
                      self.gf('django.db.models.fields.CharField')(default='manual', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ManagedHost.install_method'
        db.delete_column('chroma_core_managedhost', 'install_method')
    ...
    models = {
        ...
        'chroma_core.registrationtoken': {
            ...
            'expiry': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 25, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['chroma_core.ServerProfile']", 'null': 'True'}),
            'secret': ('django.db.models.fields.CharField', [], {'default': "'1A388837BFAC19906059CAF372B36782'", 'max_length': '32'})
        },
