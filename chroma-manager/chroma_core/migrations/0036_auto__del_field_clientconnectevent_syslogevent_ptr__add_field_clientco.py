...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClientConnectEvent.message_str'
        db.add_column('chroma_core_clientconnectevent', 'message_str', self.gf('django.db.models.fields.CharField')(default=None, max_length=512), keep_default=False)

        # Adding field 'ClientConnectEvent.lustre_pid'
        db.add_column('chroma_core_clientconnectevent', 'lustre_pid', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Deleting field 'ClientConnectEvent.syslogevent_ptr'
        db.delete_column('chroma_core_clientconnectevent', 'syslogevent_ptr_id')

        # Adding field 'ClientConnectEvent.event_ptr'
        db.add_column('chroma_core_clientconnectevent', 'event_ptr', self.gf('django.db.models.fields.related.OneToOneField')(default=None, to=orm['chroma_core.Event'], unique=True, primary_key=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ClientConnectEvent.event_ptr'
        db.delete_column('chroma_core_clientconnectevent', 'event_ptr_id')

        # Adding field 'ClientConnectEvent.syslogevent_ptr'
        db.add_column('chroma_core_clientconnectevent', 'syslogevent_ptr', self.gf('django.db.models.fields.related.OneToOneField')(default=None, to=orm['chroma_core.SyslogEvent'], unique=True, primary_key=True), keep_default=False)

        # Deleting field 'ClientConnectEvent.message_str'
        db.delete_column('chroma_core_clientconnectevent', 'message_str')

        # Deleting field 'ClientConnectEvent.lustre_pid'
        db.delete_column('chroma_core_clientconnectevent', 'lustre_pid')
    ...
    models = {
        'chroma_core.agentsession': {
            ...
            'session_id': ('django.db.models.fields.CharField', [], {'default': "'048bd3c7'", 'max_length': '8'})
        },
