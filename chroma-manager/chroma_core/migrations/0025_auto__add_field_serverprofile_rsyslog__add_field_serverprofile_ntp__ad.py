...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ServerProfile.rsyslog'
        db.add_column('chroma_core_serverprofile', 'rsyslog',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ServerProfile.ntp'
        db.add_column('chroma_core_serverprofile', 'ntp',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ServerProfile.corosync'
        db.add_column('chroma_core_serverprofile', 'corosync',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ServerProfile.corosync2'
        db.add_column('chroma_core_serverprofile', 'corosync2',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ServerProfile.pacemaker'
        db.add_column('chroma_core_serverprofile', 'pacemaker',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ServerProfile.rsyslog'
        db.delete_column('chroma_core_serverprofile', 'rsyslog')

        # Deleting field 'ServerProfile.ntp'
        db.delete_column('chroma_core_serverprofile', 'ntp')

        # Deleting field 'ServerProfile.corosync'
        db.delete_column('chroma_core_serverprofile', 'corosync')

        # Deleting field 'ServerProfile.corosync2'
        db.delete_column('chroma_core_serverprofile', 'corosync2')

        # Deleting field 'ServerProfile.pacemaker'
        db.delete_column('chroma_core_serverprofile', 'pacemaker')
    ...
    models = {
        ...
        'chroma_core.registrationtoken': {
            ...
            'expiry': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 11, 26, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['chroma_core.ServerProfile']", 'null': 'True'}),
            'secret': ('django.db.models.fields.CharField', [], {'default': "'6996E1B499392B1656EBD787FE7AF02A'", 'max_length': '32'})
        },
