...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ManagedOst.index'
        db.add_column('chroma_core_managedost', 'index',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ManagedFilesystem.mdt_next_index'
        db.add_column('chroma_core_managedfilesystem', 'mdt_next_index',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ManagedFilesystem.ost_next_index'
        db.add_column('chroma_core_managedfilesystem', 'ost_next_index',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ManagedMdt.index'
        db.add_column('chroma_core_managedmdt', 'index',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


        # Changing field 'StorageResourceLearnEvent.storage_resource'
        db.alter_column('chroma_core_storageresourcelearnevent', 'storage_resource_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chroma_core.StorageResourceRecord'], on_delete=models.PROTECT))

        # Changing field 'StorageResourceRecord.storage_id_scope'
        db.alter_column('chroma_core_storageresourcerecord', 'storage_id_scope_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chroma_core.StorageResourceRecord'], null=True, on_delete=models.PROTECT))

        # Changing field 'StorageResourceRecord.resource_class'
        db.alter_column('chroma_core_storageresourcerecord', 'resource_class_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chroma_core.StorageResourceClass'], on_delete=models.PROTECT))

        # Changing field 'StorageResourceStatistic.storage_resource'
        db.alter_column('chroma_core_storageresourcestatistic', 'storage_resource_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chroma_core.StorageResourceRecord'], on_delete=models.PROTECT))

        # Changing field 'StorageResourceClass.storage_plugin'
        db.alter_column('chroma_core_storageresourceclass', 'storage_plugin_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chroma_core.StoragePluginRecord'], on_delete=models.PROTECT))

        # Changing field 'StorageResourceAttributeReference.value'
        db.alter_column('chroma_core_storageresourceattributereference', 'value_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['chroma_core.StorageResourceRecord']))

        # Changing field 'Volume.storage_resource'
        db.alter_column('chroma_core_volume', 'storage_resource_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chroma_core.StorageResourceRecord'], null=True, on_delete=models.PROTECT))

    def backwards(self, orm):
        # Deleting field 'ManagedOst.index'
        db.delete_column('chroma_core_managedost', 'index')

        # Deleting field 'ManagedFilesystem.mdt_next_index'
        db.delete_column('chroma_core_managedfilesystem', 'mdt_next_index')

        # Deleting field 'ManagedFilesystem.ost_next_index'
        db.delete_column('chroma_core_managedfilesystem', 'ost_next_index')

        # Deleting field 'ManagedMdt.index'
        db.delete_column('chroma_core_managedmdt', 'index')


        # Changing field 'StorageResourceLearnEvent.storage_resource'
        db.alter_column('chroma_core_storageresourcelearnevent', 'storage_resource_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chroma_core.StorageResourceRecord']))

        # Changing field 'StorageResourceRecord.storage_id_scope'
        db.alter_column('chroma_core_storageresourcerecord', 'storage_id_scope_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chroma_core.StorageResourceRecord'], null=True))

        # Changing field 'StorageResourceRecord.resource_class'
        db.alter_column('chroma_core_storageresourcerecord', 'resource_class_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chroma_core.StorageResourceClass']))

        # Changing field 'StorageResourceStatistic.storage_resource'
        db.alter_column('chroma_core_storageresourcestatistic', 'storage_resource_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chroma_core.StorageResourceRecord']))

        # Changing field 'StorageResourceClass.storage_plugin'
        db.alter_column('chroma_core_storageresourceclass', 'storage_plugin_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chroma_core.StoragePluginRecord']))

        # Changing field 'StorageResourceAttributeReference.value'
        db.alter_column('chroma_core_storageresourceattributereference', 'value_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['chroma_core.StorageResourceRecord']))

        # Changing field 'Volume.storage_resource'
        db.alter_column('chroma_core_volume', 'storage_resource_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chroma_core.StorageResourceRecord'], null=True))
    ...
    models = {
        ...
        'chroma_core.agentsession': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'session_id': ('django.db.models.fields.CharField', [], {'default': "'a4eeb7de'", 'max_length': '8'})
        },
