...
base_tables = [
  ...
  "alertsubscription",
  "applyconfparams",
  "autoconfigurecorosync2job",
  "autoconfigurecorosyncjob",
  "bundle",
  "clientcertificate",
  "command",
  "command_jobs",
  "configurecopytooljob",
  "configurecorosync2job",
  "configurecorosyncjob",
  "configurehostfencingjob",
  "configurelnetjob",
  "configurentpjob",
  "configurepacemakerjob",
  "configurersyslogjob",
  "configuretargetjob",
  "confparam",
  "copytool",
  ...
  "getcorosyncstatejob",
  "getlnetstatejob",
  "getpacemakerstatejob",
  "installhostpackagesjob",
  "job",
  "lnetconfiguration",
  "loadlnetjob",
  "logmessage",
  "lustreclientmount",
  "makeavailablefilesystemunavailable",
  "managedfilesystem",
  "managedhost",
  "managedhost_ha_cluster_peers",
  "managedmdt",
  "managedmgs",
  "managedost",
  "managedtarget",
  ...
  "registertargetjob",
  "registrationtoken",
  "removeconfiguredtargetjob",
  "removecopytooljob",
  "removefilesystemjob",
  "removehostjob",
  "removelustreclientjob",
  "removemanagedhostjob",
  "removetargetjob",
  "removeunconfiguredcopytooljob",
  "removeunconfiguredhostjob",
  "rsyslogconfiguration",
  "series",
  "serverprofile",
  "serverprofile_bundles",
  "serverprofilepackage",
  "serverprofilevalidation",
  "sethostprofilejob",
  "setuphostjob",
  "setupmonitoredhostjob",
  "setupworkerjob",
  "shutdownhostjob",
  "simplehistostorebin",
  "simplehistostoretime",
  "startcopytooljob",
  "startcorosync2job",
  "startcorosyncjob",
  "startlnetjob",
  "startpacemakerjob",
  "startstoppedfilesystemjob",
  "starttargetjob",
  "startunavailablefilesystemjob",
  "stepresult",
  "stopcopytooljob",
  "stopcorosync2job",
  "stopcorosyncjob",
  ...
  "stoppacemakerjob",
  "stoptargetjob",
  "stopunavailablefilesystemjob",
  "storagealertpropagated",
  "storagepluginrecord",
  "storageresourceattributereference",
  "storageresourceattributeserialized",
  "storageresourceclass",
  "storageresourceclassstatistic",
  "storageresourcerecord",
  "storageresourcerecord_parents",
  "storageresourcerecord_reported_by",
  "storageresourcestatistic",
  "targetrecoveryinfo",
  "testhostconnectionjob",
  "triggerpluginupdatesjob",
  "unconfigurecorosync2job",
  "unconfigurecorosyncjob",
  "unconfigurelnetjob",
  "unconfigurentpjob",
  "unconfigurepacemakerjob",
  "unconfigurersyslogjob",
  "unloadlnetjob",
  "unmountlustreclientmountjob",
...
tables = map(lambda x: 'chroma_core_' + x, base_tables)


def build_from_template(template, xs):
    xs = map(lambda x: template % {"table_name": x}, tables)
    return reduce(lambda x, y: x + y, xs)

table_update_notify_str = """
...
forward_tables_template = """
DROP TRIGGER IF EXISTS %(table_name)s_notify_update
ON %(table_name)s;

DROP TRIGGER IF EXISTS %(table_name)s_notify_insert
ON %(table_name)s;

DROP TRIGGER IF EXISTS %(table_name)s_notify_delete
ON %(table_name)s;

CREATE TRIGGER %(table_name)s_notify_update
AFTER UPDATE ON %(table_name)s
FOR EACH ROW EXECUTE PROCEDURE table_update_notify();

CREATE TRIGGER %(table_name)s_notify_insert
AFTER INSERT ON %(table_name)s
FOR EACH ROW EXECUTE PROCEDURE table_update_notify();

CREATE TRIGGER %(table_name)s_notify_delete
AFTER DELETE ON %(table_name)s
FOR EACH ROW EXECUTE PROCEDURE table_update_notify();

"""

backward_tables_template = """
DROP TRIGGER %(table_name)s_notify_update
ON %(table_name)s;

DROP TRIGGER %(table_name)s_notify_insert
ON %(table_name)s;

DROP TRIGGER %(table_name)s_notify_delete
ON %(table_name)s;
...
forward_tables_str = build_from_template(forward_tables_template, tables)

backward_tables_str = build_from_template(backward_tables_template, tables)

forward_tables_xs = map(lambda x: forward_tables_template % {"table_name": x}, tables)
forward_tables_str = reduce(lambda x, y: x + y, forward_tables_xs)

class Migration(SchemaMigration):

    def forwards(self, orm):
        db.execute(table_update_notify_str + forward_tables_str)

    def backwards(self, orm):
        db.execute(backward_tables_str)
    ...
    models = {
        ...
        'chroma_core.registrationtoken': {
            ...
            'expiry': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 7, 11, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['chroma_core.ServerProfile']", 'null': 'True'}),
            'secret': ('django.db.models.fields.CharField', [], {'default': "'F8D2E0979BE7F1CC72570109C3366162'", 'max_length': '32'})
        },
