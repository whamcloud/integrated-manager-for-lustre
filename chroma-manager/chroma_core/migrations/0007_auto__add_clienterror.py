...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ClientError'
        db.create_table('chroma_core_clienterror', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('browser', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ...
            ('stack', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('user_agent', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('chroma_core', ['ClientError'])


    def backwards(self, orm):
        # Deleting model 'ClientError'
        db.delete_table('chroma_core_clienterror')
    ...
    models = {
        ...
        'chroma_core.clienterror': {
            'Meta': {'object_name': 'ClientError'},
            'browser': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            ...
            'stack': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
        ...
        'chroma_core.registrationtoken': {
            ...
            'expiry': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 23, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['chroma_core.ServerProfile']", 'null': 'True'}),
            'secret': ('django.db.models.fields.CharField', [], {'default': "'E39AF8B872322EA3037083B044C3BDD6'", 'max_length': '32'})
        },
