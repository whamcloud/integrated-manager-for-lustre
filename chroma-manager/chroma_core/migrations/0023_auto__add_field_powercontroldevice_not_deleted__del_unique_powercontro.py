...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'PowerControlDevice', fields ['port', 'address']
        db.delete_unique('chroma_core_powercontroldevice', ['port', 'address'])

        # Adding field 'PowerControlDevice.not_deleted'
        db.add_column('chroma_core_powercontroldevice', 'not_deleted',
                      self.gf('django.db.models.fields.NullBooleanField')(default=True, null=True, blank=True),
                      keep_default=False)

        # Adding unique constraint on 'PowerControlDevice', fields ['not_deleted', 'port', 'address']
        db.create_unique('chroma_core_powercontroldevice', ['not_deleted', 'port', 'address'])


    def backwards(self, orm):
        # Removing unique constraint on 'PowerControlDevice', fields ['not_deleted', 'port', 'address']
        db.delete_unique('chroma_core_powercontroldevice', ['not_deleted', 'port', 'address'])

        # Deleting field 'PowerControlDevice.not_deleted'
        db.delete_column('chroma_core_powercontroldevice', 'not_deleted')

        # Adding unique constraint on 'PowerControlDevice', fields ['port', 'address']
        db.create_unique('chroma_core_powercontroldevice', ['port', 'address'])
    ...
    models = {
        ...
        'chroma_core.registrationtoken': {
            ...
            'expiry': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 25, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'secret': ('django.db.models.fields.CharField', [], {'default': "'4A6A1F6C6B97C0B7961804EF204C9AD9'", 'max_length': '32'})
        },
