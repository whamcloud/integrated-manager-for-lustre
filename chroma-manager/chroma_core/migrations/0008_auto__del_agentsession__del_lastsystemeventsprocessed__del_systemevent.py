...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ManagedHost.agent_token'
        db.delete_column('chroma_core_managedhost', 'agent_token')


        # Changing field 'ManagedHost.nodename'
        db.alter_column('chroma_core_managedhost', 'nodename', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'ManagedHost.fqdn'
        db.alter_column('chroma_core_managedhost', 'fqdn', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
    ...
    def backwards(self, orm):
        ...
        db.create_table('chroma_core_agentsession', (
            ...
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('session_id', self.gf('django.db.models.fields.CharField')(default='a4eeb7de', max_length=8)),
        ...
        db.create_table(u'SystemEvents', (
            ...
            ('fromhost', self.gf('django.db.models.fields.CharField')(max_length=255, db_column='FromHost', blank=True)),
        ...
        db.add_column('chroma_core_managedhost', 'last_contact',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ManagedHost.agent_token'
        db.add_column('chroma_core_managedhost', 'agent_token',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64),
                      keep_default=False)


        # Changing field 'ManagedHost.nodename'
        db.alter_column('chroma_core_managedhost', 'nodename', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'ManagedHost.fqdn'
        db.alter_column('chroma_core_managedhost', 'fqdn', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
