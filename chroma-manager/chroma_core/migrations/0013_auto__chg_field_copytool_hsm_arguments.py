...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Copytool.hsm_arguments'
        db.alter_column('chroma_core_copytool', 'hsm_arguments', self.gf('django.db.models.fields.CharField')(max_length=131072))

    def backwards(self, orm):

        # Changing field 'Copytool.hsm_arguments'
        db.alter_column('chroma_core_copytool', 'hsm_arguments', self.gf('django.db.models.fields.CharField')(max_length=262144))
    ...
    models = {
        ...
        'chroma_core.registrationtoken': {
            ...
            'expiry': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 21, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['chroma_core.ServerProfile']", 'null': 'True'}),
            'secret': ('django.db.models.fields.CharField', [], {'default': "'35446A5C5AFB07D4F1F32CDEA1466A8F'", 'max_length': '32'})
        },
