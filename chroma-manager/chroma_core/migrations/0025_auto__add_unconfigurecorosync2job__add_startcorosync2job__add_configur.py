...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UnconfigureCorosync2Job'
        db.create_table('chroma_core_unconfigurecorosync2job', (
            ...
            ('corosync_configuration', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chroma_core.Corosync2Configuration'])),
        ))
        db.send_create_signal('chroma_core', ['UnconfigureCorosync2Job'])

        # Adding model 'StartCorosync2Job'
        db.create_table('chroma_core_startcorosync2job', (
            ('job_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['chroma_core.Job'], unique=True, primary_key=True)),
            ('old_state', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('corosync_configuration', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chroma_core.Corosync2Configuration'])),
        ))
        db.send_create_signal('chroma_core', ['StartCorosync2Job'])

        # Adding model 'ConfigureCorosync2Job'
        db.create_table('chroma_core_configurecorosync2job', (
            ('job_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['chroma_core.Job'], unique=True, primary_key=True)),
            ('network_interface_0', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['chroma_core.NetworkInterface'])),
            ('network_interface_1', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['chroma_core.NetworkInterface'])),
            ('mcast_port', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('corosync_configuration', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chroma_core.Corosync2Configuration'])),
        ))
        db.send_create_signal('chroma_core', ['ConfigureCorosync2Job'])

        # Adding model 'Corosync2Configuration'
        db.create_table('chroma_core_corosync2configuration', (
            ('corosyncconfiguration_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['chroma_core.CorosyncConfiguration'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('chroma_core', ['Corosync2Configuration'])

        # Adding model 'StopCorosync2Job'
        db.create_table('chroma_core_stopcorosync2job', (
            ('job_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['chroma_core.Job'], unique=True, primary_key=True)),
            ('old_state', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('corosync_configuration', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chroma_core.Corosync2Configuration'])),
        ))
        db.send_create_signal('chroma_core', ['StopCorosync2Job'])

        # Adding model 'AutoConfigureCorosync2Job'
        db.create_table('chroma_core_autoconfigurecorosync2job', (
            ('job_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['chroma_core.Job'], unique=True, primary_key=True)),
            ('old_state', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('corosync_configuration', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chroma_core.Corosync2Configuration'])),
        ))
        db.send_create_signal('chroma_core', ['AutoConfigureCorosync2Job'])

        # Adding field 'CorosyncConfiguration.record_type'
        db.add_column('chroma_core_corosyncconfiguration', 'record_type',
                      self.gf('django.db.models.fields.CharField')(default='CorosyncConfiguration', max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'UnconfigureCorosync2Job'
        db.delete_table('chroma_core_unconfigurecorosync2job')

        # Deleting model 'StartCorosync2Job'
        db.delete_table('chroma_core_startcorosync2job')

        # Deleting model 'ConfigureCorosync2Job'
        db.delete_table('chroma_core_configurecorosync2job')

        # Deleting model 'Corosync2Configuration'
        db.delete_table('chroma_core_corosync2configuration')

        # Deleting model 'StopCorosync2Job'
        db.delete_table('chroma_core_stopcorosync2job')

        # Deleting model 'AutoConfigureCorosync2Job'
        db.delete_table('chroma_core_autoconfigurecorosync2job')

        # Deleting field 'CorosyncConfiguration.record_type'
        db.delete_column('chroma_core_corosyncconfiguration', 'record_type')
    ...
    models = {
        ...
        'chroma_core.registrationtoken': {
            ...
            'expiry': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 10, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['chroma_core.ServerProfile']", 'null': 'True'}),
            'secret': ('django.db.models.fields.CharField', [], {'default': "'D1CFF4717C41183E059CACB1E2E552E8'", 'max_length': '32'})
        },
