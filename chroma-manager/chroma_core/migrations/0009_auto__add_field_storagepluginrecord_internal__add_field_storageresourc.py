...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StoragePluginRecord.internal'
        db.add_column('chroma_core_storagepluginrecord', 'internal', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'StorageResourceClass.user_creatable'
        db.add_column('chroma_core_storageresourceclass', 'user_creatable', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'StoragePluginRecord.internal'
        db.delete_column('chroma_core_storagepluginrecord', 'internal')

        # Deleting field 'StorageResourceClass.user_creatable'
        db.delete_column('chroma_core_storageresourceclass', 'user_creatable')
