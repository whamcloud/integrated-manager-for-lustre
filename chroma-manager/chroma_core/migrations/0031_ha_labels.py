...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for target in orm.ManagedTarget.objects.all():
            if not target.ha_label:
                target.ha_label = "%s_%s" % (target.name, target.id)
                target.save()
    ...
    models = {
        'chroma_core.agentsession': {
            ...
            'session_id': ('django.db.models.fields.CharField', [], {'default': "'4c2634ed'", 'max_length': '8'})
        },
