...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'ForgetFilesystemJob_stopped'
        db.delete_table('chroma_core_forgetfilesystemjob_stopped')

        # Deleting model 'ForgetHostJob_lnet_down'
        db.delete_table('chroma_core_forgethostjob_lnet_down')

        # Deleting model 'ForgetTargetJob_unmounted'
        db.delete_table('chroma_core_forgettargetjob_unmounted')

        # Deleting model 'RemoveTargetJob_unformatted'
        db.delete_table('chroma_core_removetargetjob_unformatted')

        # Deleting model 'ForgetTargetJob_mounted'
        db.delete_table('chroma_core_forgettargetjob_mounted')

        # Deleting model 'ForgetHostJob_lnet_unloaded'
        db.delete_table('chroma_core_forgethostjob_lnet_unloaded')

        # Deleting model 'ForgetFilesystemJob_available'
        db.delete_table('chroma_core_forgetfilesystemjob_available')

        # Deleting model 'RemoveTargetJob_formatted'
        db.delete_table('chroma_core_removetargetjob_formatted')

        # Deleting model 'ForgetHostJob_unconfigured'
        db.delete_table('chroma_core_forgethostjob_unconfigured')

        # Deleting model 'ForgetHostJob_lnet_up'
        db.delete_table('chroma_core_forgethostjob_lnet_up')

        # Deleting model 'RemoveTargetJob_registered'
        db.delete_table('chroma_core_removetargetjob_registered')

        # Deleting model 'ForgetFilesystemJob_unavailable'
        db.delete_table('chroma_core_forgetfilesystemjob_unavailable')
        ...
        # Adding model 'ForgetHostJob'
        db.create_table('chroma_core_forgethostjob', (
            ('job_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['chroma_core.Job'], unique=True, primary_key=True)),
            ('old_state', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('host', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chroma_core.ManagedHost'])),
        ))
        db.send_create_signal('chroma_core', ['ForgetHostJob'])
        ...
        # Adding field 'StartTargetJob.old_state'
        db.add_column('chroma_core_starttargetjob', 'old_state', self.gf('django.db.models.fields.CharField')(default='', max_length=32), keep_default=False)

        # Adding field 'StopUnavailableFilesystemJob.old_state'
        db.add_column('chroma_core_stopunavailablefilesystemjob', 'old_state', self.gf('django.db.models.fields.CharField')(default='', max_length=32), keep_default=False)

        # Adding field 'StartLNetJob.old_state'
        db.add_column('chroma_core_startlnetjob', 'old_state', self.gf('django.db.models.fields.CharField')(default='', max_length=32), keep_default=False)

        # Adding field 'FormatTargetJob.old_state'
        db.add_column('chroma_core_formattargetjob', 'old_state', self.gf('django.db.models.fields.CharField')(default='', max_length=32), keep_default=False)

        # Adding field 'StartStoppedFilesystemJob.old_state'
        db.add_column('chroma_core_startstoppedfilesystemjob', 'old_state', self.gf('django.db.models.fields.CharField')(default='', max_length=32), keep_default=False)

        # Adding field 'RemoveFilesystemJob.old_state'
        db.add_column('chroma_core_removefilesystemjob', 'old_state', self.gf('django.db.models.fields.CharField')(default='', max_length=32), keep_default=False)

        # Adding field 'RemoveConfiguredTargetJob.old_state'
        db.add_column('chroma_core_removeconfiguredtargetjob', 'old_state', self.gf('django.db.models.fields.CharField')(default='', max_length=32), keep_default=False)

        # Adding field 'UnloadLNetJob.old_state'
        db.add_column('chroma_core_unloadlnetjob', 'old_state', self.gf('django.db.models.fields.CharField')(default='', max_length=32), keep_default=False)

        # Adding field 'StartUnavailableFilesystemJob.old_state'
        db.add_column('chroma_core_startunavailablefilesystemjob', 'old_state', self.gf('django.db.models.fields.CharField')(default='', max_length=32), keep_default=False)

        # Adding field 'RemoveUnconfiguredHostJob.old_state'
        db.add_column('chroma_core_removeunconfiguredhostjob', 'old_state', self.gf('django.db.models.fields.CharField')(default='', max_length=32), keep_default=False)

        # Adding field 'MakeAvailableFilesystemUnavailable.old_state'
        db.add_column('chroma_core_makeavailablefilesystemunavailable', 'old_state', self.gf('django.db.models.fields.CharField')(default='', max_length=32), keep_default=False)

        # Adding field 'StopTargetJob.old_state'
        db.add_column('chroma_core_stoptargetjob', 'old_state', self.gf('django.db.models.fields.CharField')(default='', max_length=32), keep_default=False)

        # Adding field 'StopLNetJob.old_state'
        db.add_column('chroma_core_stoplnetjob', 'old_state', self.gf('django.db.models.fields.CharField')(default='', max_length=32), keep_default=False)

        # Adding field 'RegisterTargetJob.old_state'
        db.add_column('chroma_core_registertargetjob', 'old_state', self.gf('django.db.models.fields.CharField')(default='', max_length=32), keep_default=False)

        # Adding field 'ConfigureTargetJob.old_state'
        db.add_column('chroma_core_configuretargetjob', 'old_state', self.gf('django.db.models.fields.CharField')(default='', max_length=32), keep_default=False)

        # Adding field 'ConfigureLNetJob.old_state'
        db.add_column('chroma_core_configurelnetjob', 'old_state', self.gf('django.db.models.fields.CharField')(default='', max_length=32), keep_default=False)

        # Adding field 'RemoveHostJob.old_state'
        db.add_column('chroma_core_removehostjob', 'old_state', self.gf('django.db.models.fields.CharField')(default='', max_length=32), keep_default=False)

        # Adding field 'SetupHostJob.old_state'
        db.add_column('chroma_core_setuphostjob', 'old_state', self.gf('django.db.models.fields.CharField')(default='', max_length=32), keep_default=False)

        # Adding field 'LoadLNetJob.old_state'
        db.add_column('chroma_core_loadlnetjob', 'old_state', self.gf('django.db.models.fields.CharField')(default='', max_length=32), keep_default=False)


    def backwards(self, orm):
        
        # Adding model 'ForgetFilesystemJob_stopped'
        db.create_table('chroma_core_forgetfilesystemjob_stopped', (
            ('job_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['chroma_core.Job'], unique=True, primary_key=True)),
            ('filesystem', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chroma_core.ManagedFilesystem'])),
        ))
        db.send_create_signal('chroma_core', ['ForgetFilesystemJob_stopped'])

        # Adding model 'ForgetHostJob_lnet_down'
        db.create_table('chroma_core_forgethostjob_lnet_down', (
            ('host', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chroma_core.ManagedHost'])),
            ('job_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['chroma_core.Job'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('chroma_core', ['ForgetHostJob_lnet_down'])

        # Adding model 'ForgetTargetJob_unmounted'
        db.create_table('chroma_core_forgettargetjob_unmounted', (
            ('job_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['chroma_core.Job'], unique=True, primary_key=True)),
            ('target', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chroma_core.ManagedTarget'])),
        ))
        db.send_create_signal('chroma_core', ['ForgetTargetJob_unmounted'])
        ...
        # Adding model 'ForgetTargetJob_mounted'
        db.create_table('chroma_core_forgettargetjob_mounted', (
            ('job_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['chroma_core.Job'], unique=True, primary_key=True)),
            ('target', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chroma_core.ManagedTarget'])),
        ))
        db.send_create_signal('chroma_core', ['ForgetTargetJob_mounted'])

        # Adding model 'ForgetHostJob_lnet_unloaded'
        db.create_table('chroma_core_forgethostjob_lnet_unloaded', (
            ('host', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chroma_core.ManagedHost'])),
            ('job_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['chroma_core.Job'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('chroma_core', ['ForgetHostJob_lnet_unloaded'])

        # Adding model 'ForgetFilesystemJob_available'
        db.create_table('chroma_core_forgetfilesystemjob_available', (
            ('job_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['chroma_core.Job'], unique=True, primary_key=True)),
            ('filesystem', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chroma_core.ManagedFilesystem'])),
        ))
        db.send_create_signal('chroma_core', ['ForgetFilesystemJob_available'])
        ...
        # Adding model 'ForgetHostJob_unconfigured'
        db.create_table('chroma_core_forgethostjob_unconfigured', (
            ('host', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chroma_core.ManagedHost'])),
            ('job_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['chroma_core.Job'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('chroma_core', ['ForgetHostJob_unconfigured'])

        # Adding model 'ForgetHostJob_lnet_up'
        db.create_table('chroma_core_forgethostjob_lnet_up', (
            ('host', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chroma_core.ManagedHost'])),
            ('job_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['chroma_core.Job'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('chroma_core', ['ForgetHostJob_lnet_up'])
        ...
        # Adding model 'ForgetFilesystemJob_unavailable'
        db.create_table('chroma_core_forgetfilesystemjob_unavailable', (
            ('job_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['chroma_core.Job'], unique=True, primary_key=True)),
            ('filesystem', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chroma_core.ManagedFilesystem'])),
        ))
        db.send_create_signal('chroma_core', ['ForgetFilesystemJob_unavailable'])
        ...
        # Deleting model 'ForgetHostJob'
        db.delete_table('chroma_core_forgethostjob')

        # Deleting model 'ForgetFilesystemJob'
        db.delete_table('chroma_core_forgetfilesystemjob')

        # Deleting field 'StartTargetJob.old_state'
        db.delete_column('chroma_core_starttargetjob', 'old_state')

        # Deleting field 'StopUnavailableFilesystemJob.old_state'
        db.delete_column('chroma_core_stopunavailablefilesystemjob', 'old_state')

        # Deleting field 'StartLNetJob.old_state'
        db.delete_column('chroma_core_startlnetjob', 'old_state')

        # Deleting field 'FormatTargetJob.old_state'
        db.delete_column('chroma_core_formattargetjob', 'old_state')

        # Deleting field 'StartStoppedFilesystemJob.old_state'
        db.delete_column('chroma_core_startstoppedfilesystemjob', 'old_state')

        # Deleting field 'RemoveFilesystemJob.old_state'
        db.delete_column('chroma_core_removefilesystemjob', 'old_state')

        # Deleting field 'RemoveConfiguredTargetJob.old_state'
        db.delete_column('chroma_core_removeconfiguredtargetjob', 'old_state')

        # Deleting field 'UnloadLNetJob.old_state'
        db.delete_column('chroma_core_unloadlnetjob', 'old_state')

        # Deleting field 'StartUnavailableFilesystemJob.old_state'
        db.delete_column('chroma_core_startunavailablefilesystemjob', 'old_state')

        # Deleting field 'RemoveUnconfiguredHostJob.old_state'
        db.delete_column('chroma_core_removeunconfiguredhostjob', 'old_state')

        # Deleting field 'MakeAvailableFilesystemUnavailable.old_state'
        db.delete_column('chroma_core_makeavailablefilesystemunavailable', 'old_state')

        # Deleting field 'StopTargetJob.old_state'
        db.delete_column('chroma_core_stoptargetjob', 'old_state')

        # Deleting field 'StopLNetJob.old_state'
        db.delete_column('chroma_core_stoplnetjob', 'old_state')

        # Deleting field 'RegisterTargetJob.old_state'
        db.delete_column('chroma_core_registertargetjob', 'old_state')

        # Deleting field 'ConfigureTargetJob.old_state'
        db.delete_column('chroma_core_configuretargetjob', 'old_state')

        # Deleting field 'ConfigureLNetJob.old_state'
        db.delete_column('chroma_core_configurelnetjob', 'old_state')

        # Deleting field 'RemoveHostJob.old_state'
        db.delete_column('chroma_core_removehostjob', 'old_state')

        # Deleting field 'SetupHostJob.old_state'
        db.delete_column('chroma_core_setuphostjob', 'old_state')

        # Deleting field 'LoadLNetJob.old_state'
        db.delete_column('chroma_core_loadlnetjob', 'old_state')
    ...
    models = {
        'chroma_core.agentsession': {
            ...
            'session_id': ('django.db.models.fields.CharField', [], {'default': "'86f177c7'", 'max_length': '8'})
        },
        ...
        'chroma_core.forgethostjob': {
            'Meta': {'object_name': 'ForgetHostJob'},
            'host': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['chroma_core.ManagedHost']"}),
            'job_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['chroma_core.Job']", 'unique': 'True', 'primary_key': 'True'}),
            'old_state': ('django.db.models.fields.CharField', [], {'max_length': '32'})
        },
        ...
        'chroma_core.frontlinemetricstore': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'insert_time': ('chroma_core.models.utils.WorkaroundDateTimeField', [], {}),
        ...
        'chroma_core.opportunisticjob': {
            ...
            'run_at': ('chroma_core.models.utils.WorkaroundDateTimeField', [], {'null': 'True', 'blank': 'True'})
        },
