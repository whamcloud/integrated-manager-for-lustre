...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ManagedTarget.ha_label'
        db.add_column('chroma_core_managedtarget', 'ha_label', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ManagedTarget.ha_label'
        db.delete_column('chroma_core_managedtarget', 'ha_label')
    ...
    models = {
        'chroma_core.agentsession': {
            ...
            'session_id': ('django.db.models.fields.CharField', [], {'default': "'b228eac2'", 'max_length': '8'})
        },
