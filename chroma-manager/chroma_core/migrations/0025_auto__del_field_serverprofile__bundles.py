...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ServerProfile._bundles'
        db.delete_column('chroma_core_serverprofile', '_bundles')
    ...
    def backwards(self, orm):
        # Adding field 'ServerProfile._bundles'
        db.add_column('chroma_core_serverprofile', '_bundles',
