...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Sample_10', fields ['dt']
        db.create_index('chroma_core_sample_10', ['dt'])

        # Adding index on 'Sample_3600', fields ['dt']
        db.create_index('chroma_core_sample_3600', ['dt'])

        # Adding index on 'Sample_300', fields ['dt']
        db.create_index('chroma_core_sample_300', ['dt'])

        # Adding index on 'Sample_86400', fields ['dt']
        db.create_index('chroma_core_sample_86400', ['dt'])

        # Adding index on 'Sample_60', fields ['dt']
        db.create_index('chroma_core_sample_60', ['dt'])


    def backwards(self, orm):
        # Removing index on 'Sample_60', fields ['dt']
        db.delete_index('chroma_core_sample_60', ['dt'])

        # Removing index on 'Sample_86400', fields ['dt']
        db.delete_index('chroma_core_sample_86400', ['dt'])

        # Removing index on 'Sample_300', fields ['dt']
        db.delete_index('chroma_core_sample_300', ['dt'])

        # Removing index on 'Sample_3600', fields ['dt']
        db.delete_index('chroma_core_sample_3600', ['dt'])

        # Removing index on 'Sample_10', fields ['dt']
        db.delete_index('chroma_core_sample_10', ['dt'])
    ...
    models = {
        ...
        'chroma_core.registrationtoken': {
            ...
            'expiry': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 8, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['chroma_core.ServerProfile']", 'null': 'True'}),
            'secret': ('django.db.models.fields.CharField', [], {'default': "'11ABF607D30FEA9D8332B5F76963B1B0'", 'max_length': '32'})
        },
