...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('chroma_core_registrationtoken', (
            ...
            ('expiry', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 1, 21, 0, 0))),
            ('cancelled', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('secret', self.gf('django.db.models.fields.CharField')(default="tN\xc0eS\xed=7K\xa5\xc1\xa9\xbcO'q", max_length=32)),
    ...
    models = {
        ...
        'chroma_core.hostrebootevent': {
            'Meta': {'object_name': 'HostRebootEvent', '_ormbases': ['chroma_core.Event']},
