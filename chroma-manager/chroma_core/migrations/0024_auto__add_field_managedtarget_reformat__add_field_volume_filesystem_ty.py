...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ManagedTarget.reformat'
        db.add_column('chroma_core_managedtarget', 'reformat',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Volume.filesystem_type'
        db.add_column('chroma_core_volume', 'filesystem_type',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ManagedTarget.reformat'
        db.delete_column('chroma_core_managedtarget', 'reformat')

        # Deleting field 'Volume.filesystem_type'
        db.delete_column('chroma_core_volume', 'filesystem_type')
    ...
    models = {
        ...
        'chroma_core.registrationtoken': {
            ...
            'expiry': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 26, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'secret': ('django.db.models.fields.CharField', [], {'default': "'E59272858FCDCE6409531E69038F0E14'", 'max_length': '32'})
        },
