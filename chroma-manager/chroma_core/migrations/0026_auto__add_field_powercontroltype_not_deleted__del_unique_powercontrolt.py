...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'PowerControlDeviceOutlet', fields ['device', 'host', 'identifier']
        db.delete_unique('chroma_core_powercontroldeviceoutlet', ['device_id', 'host_id', 'identifier'])

        # Removing unique constraint on 'PowerControlType', fields ['make', 'model', 'agent']
        db.delete_unique('chroma_core_powercontroltype', ['make', 'model', 'agent'])

        # Adding field 'PowerControlType.not_deleted'
        db.add_column('chroma_core_powercontroltype', 'not_deleted',
                      self.gf('django.db.models.fields.NullBooleanField')(default=True, null=True, blank=True),
                      keep_default=False)

        # Adding unique constraint on 'PowerControlType', fields ['not_deleted', 'make', 'model', 'agent']
        db.create_unique('chroma_core_powercontroltype', ['not_deleted', 'make', 'model', 'agent'])

        # Adding field 'PowerControlDeviceOutlet.not_deleted'
        db.add_column('chroma_core_powercontroldeviceoutlet', 'not_deleted',
                      self.gf('django.db.models.fields.NullBooleanField')(default=True, null=True, blank=True),
                      keep_default=False)

        # Adding unique constraint on 'PowerControlDeviceOutlet', fields ['device', 'host', 'identifier', 'not_deleted']
        db.create_unique('chroma_core_powercontroldeviceoutlet', ['device_id', 'host_id', 'identifier', 'not_deleted'])


    def backwards(self, orm):
        # Removing unique constraint on 'PowerControlDeviceOutlet', fields ['device', 'host', 'identifier', 'not_deleted']
        db.delete_unique('chroma_core_powercontroldeviceoutlet', ['device_id', 'host_id', 'identifier', 'not_deleted'])

        # Removing unique constraint on 'PowerControlType', fields ['not_deleted', 'make', 'model', 'agent']
        db.delete_unique('chroma_core_powercontroltype', ['not_deleted', 'make', 'model', 'agent'])

        # Deleting field 'PowerControlType.not_deleted'
        db.delete_column('chroma_core_powercontroltype', 'not_deleted')

        # Adding unique constraint on 'PowerControlType', fields ['make', 'model', 'agent']
        db.create_unique('chroma_core_powercontroltype', ['make', 'model', 'agent'])

        # Deleting field 'PowerControlDeviceOutlet.not_deleted'
        db.delete_column('chroma_core_powercontroldeviceoutlet', 'not_deleted')

        # Adding unique constraint on 'PowerControlDeviceOutlet', fields ['device', 'host', 'identifier']
        db.create_unique('chroma_core_powercontroldeviceoutlet', ['device_id', 'host_id', 'identifier'])
    ...
    models = {
        ...
        'chroma_core.registrationtoken': {
            ...
            'expiry': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 28, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'secret': ('django.db.models.fields.CharField', [], {'default': "'5720287D8E79EF9D13632F3AE8638DB4'", 'max_length': '32'})
        },
