...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Job.wait_for_count'
        db.delete_column('chroma_core_job', 'wait_for_count')

        # Deleting field 'Job.wait_for_completions'
        db.delete_column('chroma_core_job', 'wait_for_completions')

        # Adding field 'Job.wait_for_json'
        db.add_column('chroma_core_job', 'wait_for_json', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

        # Adding field 'Job.locks_json'
        db.add_column('chroma_core_job', 'locks_json', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Command.jobs_created'
        db.add_column('chroma_core_command', 'jobs_created', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Job.wait_for_count'
        db.add_column('chroma_core_job', 'wait_for_count', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'Job.wait_for_completions'
        db.add_column('chroma_core_job', 'wait_for_completions', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Deleting field 'Job.wait_for_json'
        db.delete_column('chroma_core_job', 'wait_for_json')

        # Deleting field 'Job.locks_json'
        db.delete_column('chroma_core_job', 'locks_json')
    ...
    models = {
        'chroma_core.agentsession': {
            ...
            'session_id': ('django.db.models.fields.CharField', [], {'default': "'d0e02e06'", 'max_length': '8'})
        },
