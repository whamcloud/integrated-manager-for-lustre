...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RemoveLustreClientJob'
        db.create_table('chroma_core_removelustreclientjob', (
            ...
            ('lustre_client_mount', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chroma_core.LustreClientMount'])),
        ))
        db.send_create_signal('chroma_core', ['RemoveLustreClientJob'])

        # Adding model 'StopCopytoolJob'
        db.create_table('chroma_core_stopcopytooljob', (
            ('job_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['chroma_core.Job'], unique=True, primary_key=True)),
            ('old_state', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('copytool', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chroma_core.Copytool'])),
        ))
        db.send_create_signal('chroma_core', ['StopCopytoolJob'])

        # Adding model 'StartCopytoolJob'
        db.create_table('chroma_core_startcopytooljob', (
            ('job_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['chroma_core.Job'], unique=True, primary_key=True)),
            ('old_state', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('copytool', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chroma_core.Copytool'])),
        ))
        db.send_create_signal('chroma_core', ['StartCopytoolJob'])

        # Adding model 'CopytoolOperation'
        db.create_table('chroma_core_copytooloperation', (
            ...
            ('copytool', self.gf('django.db.models.fields.related.ForeignKey')(related_name='operations', to=orm['chroma_core.Copytool'])),
            ...
            ('processed_bytes', self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True)),
            ('total_bytes', self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True)),
            ('path', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True)),
            ('fid', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True)),
            ('info', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
        ))
        db.send_create_signal('chroma_core', ['CopytoolOperation'])

        # Adding unique constraint on 'CopytoolOperation', fields ['state', 'copytool', 'fid', 'started_at', 'finished_at']
        db.create_unique('chroma_core_copytooloperation', ['state', 'copytool_id', 'fid', 'started_at', 'finished_at'])

        # Adding model 'MountLustreClientJob'
        db.create_table('chroma_core_mountlustreclientjob', (
            ('job_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['chroma_core.Job'], unique=True, primary_key=True)),
            ('old_state', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('lustre_client_mount', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chroma_core.LustreClientMount'])),
        ))
        db.send_create_signal('chroma_core', ['MountLustreClientJob'])

        # Adding model 'UnmountLustreClientMountJob'
        db.create_table('chroma_core_unmountlustreclientmountjob', (
            ('job_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['chroma_core.Job'], unique=True, primary_key=True)),
            ('old_state', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('lustre_client_mount', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chroma_core.LustreClientMount'])),
        ))
        db.send_create_signal('chroma_core', ['UnmountLustreClientMountJob'])

        # Adding model 'ConfigureCopytoolJob'
        db.create_table('chroma_core_configurecopytooljob', (
            ('job_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['chroma_core.Job'], unique=True, primary_key=True)),
            ('old_state', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('copytool', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chroma_core.Copytool'])),
        ))
        db.send_create_signal('chroma_core', ['ConfigureCopytoolJob'])

        # Adding model 'RemoveUnconfiguredCopytoolJob'
        db.create_table('chroma_core_removeunconfiguredcopytooljob', (
            ('job_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['chroma_core.Job'], unique=True, primary_key=True)),
            ('old_state', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('copytool', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chroma_core.Copytool'])),
        ))
        db.send_create_signal('chroma_core', ['RemoveUnconfiguredCopytoolJob'])

        # Adding model 'ForceRemoveCopytoolJob'
        db.create_table('chroma_core_forceremovecopytooljob', (
            ('job_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['chroma_core.Job'], unique=True, primary_key=True)),
            ('copytool', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chroma_core.Copytool'])),
        ))
        db.send_create_signal('chroma_core', ['ForceRemoveCopytoolJob'])

        # Adding model 'Copytool'
        db.create_table('chroma_core_copytool', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('host', self.gf('django.db.models.fields.related.ForeignKey')(related_name='copytools', to=orm['chroma_core.ManagedHost'])),
            ('index', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('bin_path', self.gf('django.db.models.fields.CharField')(max_length=1024)),
            ('archive', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('filesystem', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chroma_core.ManagedFilesystem'])),
            ('mountpoint', self.gf('django.db.models.fields.CharField')(default='/mnt/lustre', max_length=1024)),
            ('hsm_arguments', self.gf('django.db.models.fields.CharField')(max_length=262144)),
            ...
            ('client_mount', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='copytools', null=True, to=orm['chroma_core.LustreClientMount'])),
            ('not_deleted', self.gf('django.db.models.fields.NullBooleanField')(default=True, null=True, blank=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True)),
        ))
        db.send_create_signal('chroma_core', ['Copytool'])

        # Adding unique constraint on 'Copytool', fields ['host', 'bin_path', 'filesystem', 'archive', 'index', 'not_deleted']
        db.create_unique('chroma_core_copytool', ['host_id', 'bin_path', 'filesystem_id', 'archive', 'index', 'not_deleted'])

        # Adding model 'RemoveCopytoolJob'
        db.create_table('chroma_core_removecopytooljob', (
            ('job_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['chroma_core.Job'], unique=True, primary_key=True)),
            ('old_state', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('copytool', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chroma_core.Copytool'])),
        ))
        db.send_create_signal('chroma_core', ['RemoveCopytoolJob'])


    def backwards(self, orm):
        # Removing unique constraint on 'Copytool', fields ['host', 'bin_path', 'filesystem', 'archive', 'index', 'not_deleted']
        db.delete_unique('chroma_core_copytool', ['host_id', 'bin_path', 'filesystem_id', 'archive', 'index', 'not_deleted'])

        # Removing unique constraint on 'CopytoolOperation', fields ['state', 'copytool', 'fid', 'started_at', 'finished_at']
        db.delete_unique('chroma_core_copytooloperation', ['state', 'copytool_id', 'fid', 'started_at', 'finished_at'])

        # Deleting model 'RemoveLustreClientJob'
        db.delete_table('chroma_core_removelustreclientjob')

        # Deleting model 'StopCopytoolJob'
        db.delete_table('chroma_core_stopcopytooljob')

        # Deleting model 'StartCopytoolJob'
        db.delete_table('chroma_core_startcopytooljob')

        # Deleting model 'CopytoolOperation'
        db.delete_table('chroma_core_copytooloperation')

        # Deleting model 'MountLustreClientJob'
        db.delete_table('chroma_core_mountlustreclientjob')

        # Deleting model 'UnmountLustreClientMountJob'
        db.delete_table('chroma_core_unmountlustreclientmountjob')

        # Deleting model 'ConfigureCopytoolJob'
        db.delete_table('chroma_core_configurecopytooljob')

        # Deleting model 'RemoveUnconfiguredCopytoolJob'
        db.delete_table('chroma_core_removeunconfiguredcopytooljob')

        # Deleting model 'ForceRemoveCopytoolJob'
        db.delete_table('chroma_core_forceremovecopytooljob')

        # Deleting model 'Copytool'
        db.delete_table('chroma_core_copytool')

        # Deleting model 'RemoveCopytoolJob'
        db.delete_table('chroma_core_removecopytooljob')
    ...
    models = {
        ...
        'chroma_core.copytool': {
            ...
            'hsm_arguments': ('django.db.models.fields.CharField', [], {'max_length': '262144'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'chroma_core.registrationtoken': {
            ...
            'expiry': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 2, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['chroma_core.ServerProfile']", 'null': 'True'}),
            'secret': ('django.db.models.fields.CharField', [], {'default': "'036E178C0CDF18ADC6A903CB20919571'", 'max_length': '32'})
        },
