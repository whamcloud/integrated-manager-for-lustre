...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ManagedHost.boot_time'
        db.add_column('chroma_core_managedhost', 'boot_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ManagedHost.boot_time'
        db.delete_column('chroma_core_managedhost', 'boot_time')
