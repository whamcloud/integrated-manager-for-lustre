...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ManagedHost.properties'
        db.add_column('chroma_core_managedhost', 'properties',
                      self.gf('django.db.models.fields.TextField')(default='{}'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ManagedHost.properties'
        db.delete_column('chroma_core_managedhost', 'properties')
    ...
    models = {
        ...
        'chroma_core.registrationtoken': {
            ...
            'expiry': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 11, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['chroma_core.ServerProfile']", 'null': 'True'}),
            'secret': ('django.db.models.fields.CharField', [], {'default': "'940246B92BEB801740E92C7E354B6A37'", 'max_length': '32'})
        },
