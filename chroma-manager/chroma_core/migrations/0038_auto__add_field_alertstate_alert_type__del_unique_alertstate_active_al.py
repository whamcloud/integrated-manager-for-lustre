...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'AlertState', fields ['active', 'alert_item_id', 'alert_item_type', 'content_type']
        db.delete_unique('chroma_core_alertstate', ['active', 'alert_item_id', 'alert_item_type_id', 'content_type_id'])

        # Adding field 'AlertState.alert_type'
        db.add_column('chroma_core_alertstate', 'alert_type', self.gf('django.db.models.fields.CharField')(default='', max_length=128), keep_default=False)

        # Adding unique constraint on 'AlertState', fields ['active', 'alert_item_id', 'alert_type', 'alert_item_type']
        db.create_unique('chroma_core_alertstate', ['active', 'alert_item_id', 'alert_type', 'alert_item_type_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'AlertState', fields ['active', 'alert_item_id', 'alert_type', 'alert_item_type']
        db.delete_unique('chroma_core_alertstate', ['active', 'alert_item_id', 'alert_type', 'alert_item_type_id'])

        # Deleting field 'AlertState.alert_type'
        db.delete_column('chroma_core_alertstate', 'alert_type')

        # Adding unique constraint on 'AlertState', fields ['active', 'alert_item_id', 'alert_item_type', 'content_type']
        db.create_unique('chroma_core_alertstate', ['active', 'alert_item_id', 'alert_item_type_id', 'content_type_id'])
    ...
    models = {
        'chroma_core.agentsession': {
            ...
            'session_id': ('django.db.models.fields.CharField', [], {'default': "'6705e7f8'", 'max_length': '8'})
        },
