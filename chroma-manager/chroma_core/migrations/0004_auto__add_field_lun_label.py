...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Lun.label'
        db.add_column('chroma_core_lun', 'label', self.gf('django.db.models.fields.CharField')(default='MIGRATE_ME', max_length=128), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Lun.label'
        db.delete_column('chroma_core_lun', 'label')
