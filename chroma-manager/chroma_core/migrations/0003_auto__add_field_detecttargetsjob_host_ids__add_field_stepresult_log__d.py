...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DetectTargetsJob.host_ids'
        db.add_column('chroma_core_detecttargetsjob', 'host_ids', self.gf('django.db.models.fields.CharField')(default='', max_length=512), keep_default=False)

        # Adding field 'StepResult.log'
        db.add_column('chroma_core_stepresult', 'log', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

        # Deleting field 'RelearnNidsJob.host'
        db.delete_column('chroma_core_relearnnidsjob', 'host_id')

        # Adding field 'RelearnNidsJob.host_ids'
        db.add_column('chroma_core_relearnnidsjob', 'host_ids', self.gf('django.db.models.fields.CharField')(default='', max_length=512), keep_default=False)

        # Adding field 'UpdateNidsJob.host_ids'
        db.add_column('chroma_core_updatenidsjob', 'host_ids', self.gf('django.db.models.fields.CharField')(default='', max_length=512), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DetectTargetsJob.host_ids'
        db.delete_column('chroma_core_detecttargetsjob', 'host_ids')

        # Deleting field 'StepResult.log'
        db.delete_column('chroma_core_stepresult', 'log')

        # Adding field 'RelearnNidsJob.host'
        db.add_column('chroma_core_relearnnidsjob', 'host', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['chroma_core.ManagedHost']), keep_default=False)

        # Deleting field 'RelearnNidsJob.host_ids'
        db.delete_column('chroma_core_relearnnidsjob', 'host_ids')

        # Deleting field 'UpdateNidsJob.host_ids'
        db.delete_column('chroma_core_updatenidsjob', 'host_ids')
    ...
    models = {
        ...
        'chroma_core.agentsession': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'session_id': ('django.db.models.fields.CharField', [], {'default': "'5c3005fb'", 'max_length': '8'})
        },
