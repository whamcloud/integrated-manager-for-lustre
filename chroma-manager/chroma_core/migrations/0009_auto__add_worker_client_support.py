...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UnmountLustreFilesystemsJob'
        db.create_table('chroma_core_unmountlustrefilesystemsjob', (
        ...
        db.send_create_signal('chroma_core', ['UnmountLustreFilesystemsJob'])

        # Adding model 'MountLustreFilesystemsJob'
        db.create_table('chroma_core_mountlustrefilesystemsjob', (
            ('job_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['chroma_core.Job'], unique=True, primary_key=True)),
            ('host', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chroma_core.ManagedHost'])),
        ))
        db.send_create_signal('chroma_core', ['MountLustreFilesystemsJob'])

        # Adding model 'LustreClientMount'
        db.create_table('chroma_core_lustreclientmount', (
            ...
            ('mountpoint', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True)),
        ))
        db.send_create_signal('chroma_core', ['LustreClientMount'])

        # Adding unique constraint on 'LustreClientMount', fields ['host', 'filesystem', 'not_deleted']
        db.create_unique('chroma_core_lustreclientmount', ['host_id', 'filesystem_id', 'not_deleted'])

        # Adding field 'ServerProfile.worker'
        db.add_column('chroma_core_serverprofile', 'worker',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'LustreClientMount', fields ['host', 'filesystem', 'not_deleted']
        db.delete_unique('chroma_core_lustreclientmount', ['host_id', 'filesystem_id', 'not_deleted'])

        # Deleting model 'UnmountLustreFilesystemsJob'
        db.delete_table('chroma_core_unmountlustrefilesystemsjob')

        # Deleting model 'MountLustreFilesystemsJob'
        db.delete_table('chroma_core_mountlustrefilesystemsjob')

        # Deleting model 'LustreClientMount'
        db.delete_table('chroma_core_lustreclientmount')

        # Deleting field 'ServerProfile.worker'
        db.delete_column('chroma_core_serverprofile', 'worker')
    ...
    models = {
        ...
        'chroma_core.registrationtoken': {
            ...
            'expiry': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 26, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['chroma_core.ServerProfile']", 'null': 'True'}),
            'secret': ('django.db.models.fields.CharField', [], {'default': "'A4C2179B7B323AE786682626464D410E'", 'max_length': '32'})
        },
