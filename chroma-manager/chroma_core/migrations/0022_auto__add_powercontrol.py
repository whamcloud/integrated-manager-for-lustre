...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'PowerControlType', fields ['agent', 'make', 'model']
        db.create_unique('chroma_core_powercontroltype', ['agent', 'make', 'model'])
        ...
        # Adding unique constraint on 'PowerControlDeviceOutlet', fields ['device', 'identifier', 'host']
        db.create_unique('chroma_core_powercontroldeviceoutlet', ['device_id', 'identifier', 'host_id'])
        ...
        # Adding unique constraint on 'PowerControlDevice', fields ['address', 'port']
        db.create_unique('chroma_core_powercontroldevice', ['address', 'port'])


    def backwards(self, orm):
        # Removing unique constraint on 'PowerControlDevice', fields ['address', 'port']
        db.delete_unique('chroma_core_powercontroldevice', ['address', 'port'])

        # Removing unique constraint on 'PowerControlDeviceOutlet', fields ['device', 'identifier', 'host']
        db.delete_unique('chroma_core_powercontroldeviceoutlet', ['device_id', 'identifier', 'host_id'])

        # Removing unique constraint on 'PowerControlType', fields ['agent', 'make', 'model']
        db.delete_unique('chroma_core_powercontroltype', ['agent', 'make', 'model'])
    ...
    models = {
        ...
        'chroma_core.powercontroldevice': {
            'Meta': {'unique_together': "(('address', 'port'),)", 'object_name': 'PowerControlDevice'},
        ...
        'chroma_core.powercontroldeviceoutlet': {
            'Meta': {'unique_together': "(('device', 'identifier', 'host'),)", 'object_name': 'PowerControlDeviceOutlet'},
        ...
        'chroma_core.powercontroltype': {
            'Meta': {'unique_together': "(('agent', 'make', 'model'),)", 'object_name': 'PowerControlType'},
        ...
        'chroma_core.registrationtoken': {
            ...
            'expiry': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 17, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'secret': ('django.db.models.fields.CharField', [], {'default': "'CB09FD2FCBC6893387DA7D25067D3A40'", 'max_length': '32'})
        },
