...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for alert_state in orm.AlertState.objects.all():
            if not alert_state.alert_type:
                klass = ContentType.objects.get_for_id(alert_state.content_type_id).model_class()
                alert_state.alert_type = klass.__name__
                alert_state.save()
    ...
    models = {
        'chroma_core.agentsession': {
            ...
            'session_id': ('django.db.models.fields.CharField', [], {'default': "'7100549c'", 'max_length': '8'})
        },
