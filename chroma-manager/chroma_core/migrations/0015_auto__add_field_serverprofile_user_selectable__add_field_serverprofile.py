...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ServerProfile.user_selectable'
        db.add_column('chroma_core_serverprofile', 'user_selectable',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'ServerProfile.initial_state'
        db.add_column('chroma_core_serverprofile', 'initial_state',
                      self.gf('django.db.models.fields.CharField')(default='configured', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ServerProfile.user_selectable'
        db.delete_column('chroma_core_serverprofile', 'user_selectable')

        # Deleting field 'ServerProfile.initial_state'
        db.delete_column('chroma_core_serverprofile', 'initial_state')
    ...
    models = {
        ...
        'chroma_core.registrationtoken': {
            ...
            'expiry': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 5, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['chroma_core.ServerProfile']", 'null': 'True'}),
            'secret': ('django.db.models.fields.CharField', [], {'default': "'AB150E64CC1439AEF3EBC9641BC54261'", 'max_length': '32'})
        },
