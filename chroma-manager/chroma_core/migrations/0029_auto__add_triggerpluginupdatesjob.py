...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TriggerPluginUpdatesJob'
        db.create_table('chroma_core_triggerpluginupdatesjob', (
            ...
            ('plugin_names_json', self.gf('django.db.models.fields.CharField')(max_length=512)),
        ))
        db.send_create_signal('chroma_core', ['TriggerPluginUpdatesJob'])


    def backwards(self, orm):
        # Deleting model 'TriggerPluginUpdatesJob'
        db.delete_table('chroma_core_triggerpluginupdatesjob')
    ...
    models = {
        ...
        'chroma_core.registrationtoken': {
            ...
            'expiry': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 9, 16, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['chroma_core.ServerProfile']", 'null': 'True'}),
            'secret': ('django.db.models.fields.CharField', [], {'default': "'AED39C37C608AE737164E269412131B8'", 'max_length': '32'})
        },
