...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ForgetFilesystemJob.filesystem'
        db.add_column('chroma_core_forgetfilesystemjob', 'filesystem', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['chroma_core.ManagedFilesystem']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.create_table('chroma_core_opportunisticjob', (
            ...
            ('run_at', self.gf('chroma_core.models.utils.WorkaroundDateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal('chroma_core', ['OpportunisticJob'])

        # Deleting field 'ForgetFilesystemJob.filesystem'
        db.delete_column('chroma_core_forgetfilesystemjob', 'filesystem_id')
    ...
    models = {
        'chroma_core.agentsession': {
            ...
            'session_id': ('django.db.models.fields.CharField', [], {'default': "'5492ea76'", 'max_length': '8'})
        },
