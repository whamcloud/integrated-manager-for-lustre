...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Systemevents.fromhost'
        db.alter_column(u'SystemEvents', 'FromHost', self.gf('django.db.models.fields.CharField')(max_length=255, db_column='FromHost'))


    def backwards(self, orm):
        
        # Changing field 'Systemevents.fromhost'
        db.alter_column(u'SystemEvents', 'FromHost', self.gf('django.db.models.fields.CharField')(max_length=60, db_column='FromHost'))
    ...
    models = {
        ...
        'chroma_core.agentsession': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'session_id': ('django.db.models.fields.CharField', [], {'default': "'81d3c0c7'", 'max_length': '8'})
        },
