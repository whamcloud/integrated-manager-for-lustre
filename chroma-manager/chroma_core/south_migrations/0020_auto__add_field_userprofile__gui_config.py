...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile._gui_config'
        db.add_column('chroma_core_userprofile', '_gui_config',
                      self.gf('django.db.models.fields.TextField')(default='{}', db_column='gui_config'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile._gui_config'
        db.delete_column('chroma_core_userprofile', 'gui_config')
    ...
    models = {
        ...
        'chroma_core.registrationtoken': {
            ...
            'expiry': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 10, 23, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['chroma_core.ServerProfile']", 'null': 'True'}),
            'secret': ('django.db.models.fields.CharField', [], {'default': "'6C227DE1EAC0E7E09388687C9DA46DFB'", 'max_length': '32'})
        },
