...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'PowerControlDeviceOutlet', fields ['device', 'not_deleted', 'identifier']
        db.create_unique('chroma_core_powercontroldeviceoutlet', ['device_id', 'not_deleted', 'identifier'])


    def backwards(self, orm):
        # Removing unique constraint on 'PowerControlDeviceOutlet', fields ['device', 'not_deleted', 'identifier']
        db.delete_unique('chroma_core_powercontroldeviceoutlet', ['device_id', 'not_deleted', 'identifier'])
    ...
    models = {
        ...
        'chroma_core.registrationtoken': {
            ...
            'expiry': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 14, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['chroma_core.ServerProfile']", 'null': 'True'}),
            'secret': ('django.db.models.fields.CharField', [], {'default': "'CE250D5C160C5EF8FEB3E604DA3EBFA5'", 'max_length': '32'})
        },
