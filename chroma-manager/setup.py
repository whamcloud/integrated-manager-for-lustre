...
setup(
    ...
    package_data = {
        ...
        'chroma_ui': ["static/js/lib/*.js", "static/js/lib/angular/*.js",
                      ...
                      "static/js/models/*.js", "static/js/modules/login/*.js",
                      "static/js/modules/login/assets/css/*.css", "static/js/modules/login/assets/html/*.html",
        ...
        'chroma_ui_new': ["static/chroma_ui/bower_components/font-awesome/fonts/*",
                          ...
                          "static/chroma_ui/built-*.js", "templates/chroma_ui/*"],
