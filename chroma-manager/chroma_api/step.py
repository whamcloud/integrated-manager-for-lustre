...
class StepResource(ModelResource):
    ...
    exception = fields.CharField(help_text = "Stringified exception generated by a step if it failed")

    def dehydrate_exception(self, bundle):
        return "%s" % bundle.obj.exception
