...
class TestBulkResourceOperation(ChromaApiTestCase, BulkResourceOperation):
    ...
    def test_bulk_passing_case(self):
        ...
        try:
            self._bulk_operation(_passing_action, 'passing', FakeBundle({"objects": [{"data": n} for n in range(0, self.object_count)]}), None)
    ...
    def test_bulk_failing_case(self):
        ...
        try:
            self._bulk_operation(_failing_action, 'failing', FakeBundle({"objects": [{"data": n} for n in range(0, self.object_count)]}), None)
        except TestException as e:
