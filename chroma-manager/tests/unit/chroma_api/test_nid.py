...
class TestHostResource(ChromaApiTestCase):
    ...
    def setUp(self):
        ...
        mock.patch('chroma_core.services.job_scheduler.job_scheduler_client.JobSchedulerClient.update_nids',
    ...
    def test_validation_missing_lnd_type_ok(self):
        ...
        self.api_post(self.RESOURCE_PATH,
                       data={"lnd_network": -1,
