...
[lustre-client]
name=lustre-client
baseurl=https://build.whamcloud.com/job/lustre-b2_10/lastSuccessfulBuild/arch=x86_64%2Cbuild_type=client%2Cdistro=el7%2Cib_stack=inkernel/artifact/artifacts/
enabled=1
sslverify=0
gpgcheck=0
EOF
