...
yum-config-manager --add-repo https://copr.fedorainfracloud.org/coprs/joegrund/manager-for-lustre/repo/epel-7/managerforlustre-manager-for-lustre-epel-7.repo
