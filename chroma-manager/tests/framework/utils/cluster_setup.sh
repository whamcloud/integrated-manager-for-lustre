...
if [[ \$HOSTNAME = *vm*2 ]]; then
    ...
    yum-config-manager --add-repo https://build.whamcloud.com/lustre-reviews/configurations/axis-arch/\\\$basearch/axis-build_type/client/axis-distro/el7/axis-ib_stack/inkernel/builds/48896/archive/artifacts/
