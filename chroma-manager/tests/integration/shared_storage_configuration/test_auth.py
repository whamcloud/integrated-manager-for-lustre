...
class TestAuthentication(ChromaIntegrationTestCase):
    ...
    def test_user_management(self):
        superuser = config['chroma_managers'][0]['users'][0]
        superuser_requests = AuthorizedHttpRequests(superuser['username'], superuser['password'],
            server_http_url = config['chroma_managers'][0]['server_http_url'])
        ...
        basic_user_requests = AuthorizedHttpRequests(basic_user['username'], basic_user['password1'],
            server_http_url = config['chroma_managers'][0]['server_http_url'])
