...
class TestManagedFilesystemWithFailover(FailoverTestCaseMixin, StatsTestCaseMixin, ChromaIntegrationTestCase):
    ...
    def _test_create_filesystem_with_failover(self):
        ...
        volumes_expected_hosts_in_normal_state = {
            self.standard_filesystem_layout['mgt']['volume']['id']: self.standard_filesystem_layout['mgt']['primary_host'],
            self.standard_filesystem_layout['mdt']['volume']['id']: self.standard_filesystem_layout['mdt']['primary_host'],
            self.standard_filesystem_layout['ost1']['volume']['id']: self.standard_filesystem_layout['ost1']['primary_host'],
            self.standard_filesystem_layout['ost2']['volume']['id']: self.standard_filesystem_layout['ost2']['primary_host'],
        }
    ...
    @skip('Temporarily disable so we can land #244')
    def test_create_filesystem_with_failover_mgs(self):
        ...
        if config['failover_is_configured']:
            ...
            volumes_expected_hosts_in_failover_state = {
                self.standard_filesystem_layout['mgt']['volume']['id']: self.standard_filesystem_layout['mgt']['failover_host'],
                self.standard_filesystem_layout['mdt']['volume']['id']: self.standard_filesystem_layout['mdt']['primary_host'],
                self.standard_filesystem_layout['ost1']['volume']['id']: self.standard_filesystem_layout['ost1']['primary_host'],
                self.standard_filesystem_layout['ost2']['volume']['id']: self.standard_filesystem_layout['ost2']['primary_host'],
            }
    ...
    def test_create_filesystem_with_failover_mds(self):
        ...
        if config['failover_is_configured']:
            ...
            volumes_expected_hosts_in_failover_state = {
                self.standard_filesystem_layout['mgt']['volume']['id']: self.standard_filesystem_layout['mgt']['primary_host'],
                self.standard_filesystem_layout['mdt']['volume']['id']: self.standard_filesystem_layout['mdt']['failover_host'],
                self.standard_filesystem_layout['ost1']['volume']['id']: self.standard_filesystem_layout['ost1']['primary_host'],
                self.standard_filesystem_layout['ost2']['volume']['id']: self.standard_filesystem_layout['ost2']['primary_host'],
            }
    ...
    def test_create_filesystem_with_failover_oss(self):
        ...
        if config['failover_is_configured']:
            ...
            volumes_expected_hosts_in_failover_state = {
                self.standard_filesystem_layout['mgt']['volume']['id']: self.standard_filesystem_layout['mgt']['primary_host'],
                self.standard_filesystem_layout['mdt']['volume']['id']: self.standard_filesystem_layout['mdt']['primary_host'],
                self.standard_filesystem_layout['ost1']['volume']['id']: self.standard_filesystem_layout['ost1']['failover_host'],
                self.standard_filesystem_layout['ost2']['volume']['id']: self.standard_filesystem_layout['ost2']['primary_host'],
            }
    ...
    def test_create_filesystem_with_failover_oss_chroma_controlled(self):
        ...
        if config['failover_is_configured']:
            ...
            volumes_expected_hosts_in_failover_state = {
                ...
                self.standard_filesystem_layout['mdt']['volume']['id']: self.standard_filesystem_layout['mdt']['primary_host'],
                self.standard_filesystem_layout['ost1']['volume']['id']: self.standard_filesystem_layout['ost1']['primary_host'],
                self.standard_filesystem_layout['ost2']['volume']['id']: self.standard_filesystem_layout['ost2']['failover_host'],
            }
