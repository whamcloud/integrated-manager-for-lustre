...
help_text = {
    ...
    'eula': """
        ...
        <p>The Software includes all source and/or binary files provided by Intel Corporation or its majority-owned
        subsidiaries ("Intel") with this License Agreement, and any other accompanying documentation.</p>

        <ol>
          <li><h5>LICENSE GRANT.</h5> Subject to all of the terms and conditions of this Agreement, including any restrictions set forth in Section 2 below, Intel Corporation ("Intel") grants to you a non-exclusive, non-assignable, copyright license to install one copy per license and use the Software on a single server or computer Solely for the purpose of installing, configuring, monitoring and managing a Lustre file system that is obtained from the Lustre Partner Portal. Except as expressly provided in this Section 1, you will not have any other rights to the Materials.</li>
          <li><h5>LICENSE RESTRICTIONS.</h5>  You may NOT:  (i) use or copy the Materials except as provided in this Agreement; (ii) rent or lease the Materials to any third party; (iii) assign this Agreement or transfer the Materials without the express written consent of Intel; (iv) modify, adapt, or translate the Materials in whole or in part except as provided in this Agreement; (v) reverse engineer, decompile, de-obfuscate or disassemble the Materials; (vi) distribute, sublicense or transfer any components of the Materials to any third party except as provided in this Agreement; or (vii) modify or distribute the Source Code of any Materials so that any part of it becomes subject to an Excluded License.  An "Excluded License" is one that requires, as a condition of use, modification, or distribution, that (a) the code be disclosed or distributed in source code form; or (b) others have the right to modify it.  The Materials may include third party programs or materials.  The license terms with those programs or materials apply to your use of them, and Intel is not liable for them.</li>
          <li><h5>OPEN SOURCE SOFTWARE.</h5>  Certain programs and or files included with the Software may include Open Source Code (defined below). Your rights to use the Open Source Software are governed by the license agreements that accompany such components. Intel does not warrant such Open Source Software in any way and assumes no liability for your use of the Open Source Software.  You are subject to the terms of their license agreements if you use the Open Source Software.  "Open Source Code" means any software that requires as a condition of use, modification and/or distribution of such software that such software or other software incorporated into, derived from or distributed with such software (a) be disclosed or distributed in source code form; or (b) be licensed by the user to third parties for the purpose of making and/or distributing derivative works; or (c) be redistributable at no charge.  Open Source Software includes, without limitation, software licensed or distributed under any of the following licenses or distribution models, or licenses or distribution models substantially similar to any of the following: (a) GNU's General Public License (GPL) or Lesser/Library GPL (LGPL), (b) the Artistic License (e.g., PERL), (c) the Mozilla Public License, (d) the Netscape Public License, (e) the Sun Community Source License (SCSL), (f) the Sun Industry Source License (SISL), (g) the Apache Software license and (h) the Common Public License (CPL).</li>
