...
help_text = {
    ...
    'existing_keys_tooltip': 'If the management servers are configured with a set of ssh keys, those keys will be used to register the new servers.',
    ...
    'local_diff': 'This row has changed locally. Click to reset value to %(remote)s',
