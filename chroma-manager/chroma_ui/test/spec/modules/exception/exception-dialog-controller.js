describe('Exception dialog controller', function () {
  'use strict';
  ...
  beforeEach(inject(function ($rootScope, $controller) {
    ...
    createController = function createController(deps) {
      deps = window.lodash.extend({$scope: $scope}, deps);

      $controller('ExceptionDialogCtrl', deps);
    };

    getMessage = function getMessage(name) {
      return $scope.exceptionDialog.messages.filter(function (message) {
  ...
  it('should return the expected messages for a plain error', function () {
    ...
    expect($scope.exceptionDialog.messages).toEqual([
