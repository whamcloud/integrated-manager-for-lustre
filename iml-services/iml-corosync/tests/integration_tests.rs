...
extern crate iml_corosync;

use iml_corosync::{
    fetch_corosync_cluster_by_nodes, upsert_corosync_cluster, CorosyncNodeKey, ImlCorosyncError,
};
use iml_postgres::test_setup;

#[tokio::test]
#[ignore = "Requires an active and populated DB"]
async fn test_insert() -> Result<(), ImlCorosyncError> {
