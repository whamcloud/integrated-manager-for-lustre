...
use emf_util::action_plugins;
use emf_wire_types::ActionName;
use tracing::info;
...
pub fn create_registry() -> action_plugins::Actions {
    let map = action_plugins::Actions::default()
        .add_plugin("start_unit", emf_systemd::start_unit)
        .add_plugin("stop_unit", emf_systemd::stop_unit)
        .add_plugin("enable_unit", emf_systemd::enable_unit)
        .add_plugin("disable_unit", emf_systemd::disable_unit)
        .add_plugin("restart_unit", emf_systemd::restart_unit)
        .add_plugin("get_unit_run_state", emf_systemd::get_run_state)
