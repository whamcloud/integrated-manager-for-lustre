...
fn process_resource(output: &[u8]) -> Result<ResourceAgentInfo, EmfAgentError> {
...
pub async fn get_ha_resource_list(_: ()) -> Result<Vec<ResourceAgentInfo>, EmfAgentError> {
...
fn resource_xml_string(agent: &ResourceAgentInfo, cloned: bool) -> Result<String, EmfAgentError> {
...
mod tests {
    ...
    #[test]
    fn test_emf() {
        let testxml = include_bytes!("fixtures/crm-resource-emf-mgs.xml");
