...
use crate::{
    agent_error::EmfAgentError, network_interface::parse as parse_interfaces,
    network_interface_stats,
};
use emf_cmd::{CheckedCommandExt, CmdError, Command};
use emf_wire_types::{LNet, NetworkInterface};
use std::io;
...
pub async fn get_interfaces() -> Result<Vec<NetworkInterface>, EmfAgentError> {
...
pub async fn get_lnet_data() -> Result<LNet, EmfAgentError> {
