...
use emf_fs::EmfFsError;
use emf_wire_types::PluginName;
use std::{fmt, process::Output};
use thiserror::Error;
use tokio_util::codec::LinesCodecError;

pub type Result<T> = std::result::Result<T, EmfAgentError>;
...
impl From<Output> for EmfAgentError {
    fn from(output: Output) -> Self {
        EmfAgentError::CmdError(output.into())
    }
}

impl From<futures::channel::mpsc::SendError> for EmfAgentError {
    fn from(_: futures::channel::mpsc::SendError) -> Self {
        EmfAgentError::SendError
    }
}

impl serde::Serialize for EmfAgentError {
