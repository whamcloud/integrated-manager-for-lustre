...
install:
	...
	cp -a __init__.py manage.py middleware.py benchmark chroma_api chroma_core monitor.wsgi polymorphic settings.py production_version.py urls.py $(DESTDIR)/usr/share/hydra-server
