...
tags:
	...
	ctags --python-kinds=-i -R --exclude=chroma-manager/_topdir --exclude=chroma-\*/myenv\* --exclude=chroma-common --exclude=chroma-dependencies --exclude=chroma_unit_test_env --exclude=chroma-externals --exclude=chroma-manager/chroma_ui* exclude=chroma-manager/ui-modules .

# build the chroma-{common,agent,management} subdirs before the chroma-dependencies subdir
chroma-dependencies: chroma-common chroma-agent chroma-manager chroma-diagnostics
