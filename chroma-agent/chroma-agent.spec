...
Conflicts: sysklogd
Requires: %{name} = %{version}-%{release} rsyslog pacemaker python-dateutil libxml2-python python-netaddr python-ethtool python-jinja2 pcapy python-impacket fence-agent
%if 0%{?rhel} > 5
