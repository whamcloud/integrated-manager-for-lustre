...
Conflicts: sysklogd
Requires: %{name} = %{version}-%{release} rsyslog pacemaker python-dateutil >= 1.5 libxml2-python python-netaddr python-ethtool python-jinja2 pcapy python-impacket fence-agents yum-utils
%if 0%{?rhel} > 5
