...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('monitor_alertemail', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('monitor', ['AlertEmail'])

        # Adding M2M table for field alerts on 'AlertEmail'
        db.create_table('monitor_alertemail_alerts', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('alertemail', models.ForeignKey(orm['monitor.alertemail'], null=False)),
            ('alertstate', models.ForeignKey(orm['monitor.alertstate'], null=False))
        ))
        db.create_unique('monitor_alertemail_alerts', ['alertemail_id', 'alertstate_id'])


    def backwards(self, orm):
        
        # Deleting model 'AlertEmail'
        db.delete_table('monitor_alertemail')

        # Removing M2M table for field alerts on 'AlertEmail'
        db.delete_table('monitor_alertemail_alerts')
    ...
    models = {
        ...
        'monitor.alertemail': {
            ...
            'alerts': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['monitor.AlertState']", 'symmetrical': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'monitor.alertevent': {
