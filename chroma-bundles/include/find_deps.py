    ...
    def disable_all_repos(self):
        for repo in self.yb.repos.findRepos("*"):
            ...
            if repo.id != "base" and repo.id != "core-0" and \
               ...
               repo.id != "managerforlustre-manager-for-lustre-4.0.10" and \
               repo.id != "copr-be.cloud.fedoraproject.org_results_managerforlustre_manager-for-lustre-4.0.10_epel-7-x86_64_":
                repo.disable()
