...
use futures::{future, Future, FutureExt, TryFutureExt, StreamExt, TryStreamExt};
use iml_cmd::Command;
use lustre_collector::{parse_lctl_output, parse_lnetctl_output, parser, parse_meminfo_output, parse_cpustats_output};
...
impl DaemonPlugin for Stats {
    ...
    fn update_session(
        ...
        async {
            ...
            let cmd1 = cmd1.arg("get_param").args(parser::params()).output().err_into();
