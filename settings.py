...
HTTP_AGENT_PROXY_PASS = 'http://{}/:{}'.format(NGINX_HOST, HTTP_AGENT_PORT)

HTTP_API_PORT = 8001

HTTP_API_PROXY_PASS = 'http://{}/:{}'.format(NGINX_HOST, HTTP_API_PORT)

REALTIME_PORT = 8888

REALTIME_PROXY_PASS = 'http://{}/:{}'.format(NGINX_HOST, REALTIME_PORT)

VIEW_SERVER_PORT = 8889

VIEW_SERVER_PROXY_PASS = 'http://{}/:{}'.format(NGINX_HOST, VIEW_SERVER_PORT)
