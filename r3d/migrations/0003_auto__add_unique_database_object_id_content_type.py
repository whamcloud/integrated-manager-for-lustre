...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Database', fields ['object_id', 'content_type']
        db.create_unique('r3d_database', ['object_id', 'content_type_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Database', fields ['object_id', 'content_type']
        db.delete_unique('r3d_database', ['object_id', 'content_type_id'])
    ...
    models = {
        ...
        'r3d.database': {
            ...
            'start': ('django.db.models.fields.BigIntegerField', [], {'default': '1318803658'}),
