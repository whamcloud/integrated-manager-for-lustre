...
yum-config-manager --add-repo https://copr.fedorainfracloud.org/coprs/managerforlustre/manager-for-lustre-5.0/repo/epel-7/managerforlustre-manager-for-lustre-5.0-epel-7.repo
