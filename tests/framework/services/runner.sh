...
cp iml-realtime.service iml-settings-populator.service iml-stats.service iml-syslog.service /lib/systemd/system
...
cp -r /intel-manager-for-lustre /usr/share/chroma-manager
