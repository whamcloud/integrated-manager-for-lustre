...
class TestCorosyncConfiguration(TestJobs):
    def test_acc_step(self):
        ...
        mock.patch('chroma_core.models.AutoConfigureCorosyncStep._create_pcs_password', return_value='vVGuFNrZ1YUhMDEv6MDe').start()
        ...
        self.add_invokes(InvokeAgentInvoke(mock_corosync_configuration.host.fqdn,
                                           'get_corosync_autoconfig',
                                           {},
                                           {'mcast_port': mcast_port,
                                            'interfaces': {'eth1': {'dedicated': True,
                                                                    'ipaddr': eth1_ipaddr,
                                                                    'prefix': prefix},
                                                           'eth0': {'dedicated': False,
                                                                    'ipaddr': eth0_ipaddr,
                                                                    'prefix': prefix}}
                                           },
                                           None),
                         InvokeAgentInvoke(mock_corosync_configuration.host.fqdn,
                                           'configure_network',
                                           {'ring1_ipaddr': eth1_ipaddr,
                                            'ring1_name': 'eth1',
                                            'ring0_name': 'eth0',
                                            'ring1_prefix': prefix},
                                           None,
                         ...
                         InvokeAgentInvoke(mock_corosync_configuration.host.fqdn,
                                           ...
                                           None,
                                           None),
                         InvokeAgentInvoke(mock_actioning_host.fqdn,
        ...
        acc_step = AutoConfigureCorosyncStep(self.mock_job,
                                             {'corosync_configuration': mock_corosync_configuration},
                                             None,
                                             None,
                                             None)
    ...
    def test_pcs_password_masked(self):
        ...
        acc_step = AutoConfigureCorosyncStep(self.mock_job,
                                             {},
                                             None,
                                             lambda console_output: process_callback(acc_step._pcs_password,
                                                                                     console_output),
                                             None)
