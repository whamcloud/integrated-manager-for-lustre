...
use iml_wire_types::db::{
    ...
    PacemakerConfigurationRecord, SfaDiskDrive, SfaEnclosure, SfaJob, SfaPowerSupply,
    SfaStorageSystem, StratagemConfiguration, TableName, VolumeNodeRecord, VolumeRecord,
    ...
    OSTPOOL_TABLE_NAME, PACEMAKER_CONFIGURATION_TABLE_NAME, SFA_DISK_DRIVE_TABLE_NAME,
    SFA_ENCLOSURE_TABLE_NAME, SFA_JOB_TABLE_NAME, SFA_POWER_SUPPLY_TABLE_NAME,
