...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('configure_startstoppedfilesystemjob', (
        ...
        db.send_create_signal('configure', ['StartStoppedFilesystemJob'])

        # Adding model 'StartUnavailableFilesystemJob'
        db.create_table('configure_startunavailablefilesystemjob', (
            ('job_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['configure.Job'], unique=True, primary_key=True)),
            ('filesystem', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['configure.ManagedFilesystem'])),
        ))
        db.send_create_signal('configure', ['StartUnavailableFilesystemJob'])

        # Adding model 'StopUnavailableFilesystemJob'
        db.create_table('configure_stopunavailablefilesystemjob', (
            ('job_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['configure.Job'], unique=True, primary_key=True)),
            ('filesystem', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['configure.ManagedFilesystem'])),
        ))
        db.send_create_signal('configure', ['StopUnavailableFilesystemJob'])

        # Adding model 'StopAvailableFilesystemJob'
        db.create_table('configure_stopavailablefilesystemjob', (
            ('job_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['configure.Job'], unique=True, primary_key=True)),
            ('filesystem', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['configure.ManagedFilesystem'])),
        ))
        db.send_create_signal('configure', ['StopAvailableFilesystemJob'])


    def backwards(self, orm):
        
        # Deleting model 'StartStoppedFilesystemJob'
        db.delete_table('configure_startstoppedfilesystemjob')

        # Deleting model 'StartUnavailableFilesystemJob'
        db.delete_table('configure_startunavailablefilesystemjob')

        # Deleting model 'StopUnavailableFilesystemJob'
        db.delete_table('configure_stopunavailablefilesystemjob')

        # Deleting model 'StopAvailableFilesystemJob'
        db.delete_table('configure_stopavailablefilesystemjob')
    ...
    models = {
        ...
        'configure.stopavailablefilesystemjob': {
            'Meta': {'object_name': 'StopAvailableFilesystemJob', '_ormbases': ['configure.Job']},
            'filesystem': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['configure.ManagedFilesystem']"}),
            'job_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['configure.Job']", 'unique': 'True', 'primary_key': 'True'})
        },
