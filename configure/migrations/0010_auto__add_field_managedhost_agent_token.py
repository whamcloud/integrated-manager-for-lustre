...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('configure_managedhost', 'agent_token', self.gf('django.db.models.fields.CharField')(default='XXX-DEV-MIGRATION', max_length=64), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ManagedHost.agent_token'
        db.delete_column('configure_managedhost', 'agent_token')
