...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('configure_makeavailablefilesystemunavailable', (
        ...
        db.send_create_signal('configure', ['MakeAvailableFilesystemUnavailable'])


    def backwards(self, orm):
        
        # Deleting model 'MakeAvailableFilesystemUnavailable'
        db.delete_table('configure_makeavailablefilesystemunavailable')
