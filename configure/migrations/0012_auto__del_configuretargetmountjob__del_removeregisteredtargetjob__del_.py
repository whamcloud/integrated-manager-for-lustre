...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('configure_removetargetjob_registered', (
        ...
        db.send_create_signal('configure', ['RemoveTargetJob_registered'])

        # Adding model 'RemoveConfiguredTargetJob'
        db.create_table('configure_removeconfiguredtargetjob', (
            ('job_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['configure.Job'], unique=True, primary_key=True)),
            ('target', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['configure.ManagedTarget'])),
        ))
        db.send_create_signal('configure', ['RemoveConfiguredTargetJob'])

        # Adding model 'ConfigureTargetJob'
        db.create_table('configure_configuretargetjob', (
            ('job_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['configure.Job'], unique=True, primary_key=True)),
            ('target', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['configure.ManagedTarget'])),
        ))
        db.send_create_signal('configure', ['ConfigureTargetJob'])

        # Deleting field 'ManagedTargetMount.content_type'
        db.delete_column('configure_managedtargetmount', 'content_type_id')

        # Deleting field 'ManagedTargetMount.state'
        db.delete_column('configure_managedtargetmount', 'state')
    ...
    def backwards(self, orm):
        ...
        db.delete_table('configure_removetargetjob_registered')

        # Deleting model 'RemoveConfiguredTargetJob'
        db.delete_table('configure_removeconfiguredtargetjob')

        # Deleting model 'ConfigureTargetJob'
        db.delete_table('configure_configuretargetjob')

        # Adding field 'ManagedTargetMount.content_type'
        db.add_column('configure_managedtargetmount', 'content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True), keep_default=False)

        # User chose to not deal with backwards NULL issues for 'ManagedTargetMount.state'
        raise RuntimeError("Cannot reverse this migration. 'ManagedTargetMount.state' and its values cannot be restored.")
    ...
    models = {
        ...
        'configure.command': {
            ...
            'jobs': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['configure.Job']", 'symmetrical': 'False'}),
        ...
        'configure.configuretargetjob': {
            'Meta': {'object_name': 'ConfigureTargetJob', '_ormbases': ['configure.Job']},
            'job_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['configure.Job']", 'unique': 'True', 'primary_key': 'True'}),
        ...
        'configure.removeconfiguredtargetjob': {
            'Meta': {'object_name': 'RemoveConfiguredTargetJob', '_ormbases': ['configure.Job']},
            'job_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['configure.Job']", 'unique': 'True', 'primary_key': 'True'}),
            'target': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['configure.ManagedTarget']"})
        },
        ...
        'configure.removetargetjob_registered': {
            'Meta': {'object_name': 'RemoveTargetJob_registered', '_ormbases': ['configure.Job']},
            'job_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['configure.Job']", 'unique': 'True', 'primary_key': 'True'}),
            'target': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['configure.ManagedTarget']"})
        },
