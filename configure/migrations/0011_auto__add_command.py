...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('configure_command', (
        ...
        db.send_create_signal('configure', ['Command'])

        # Adding M2M table for field jobs on 'Command'
        db.create_table('configure_command_jobs', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('command', models.ForeignKey(orm['configure.command'], null=False)),
            ('job', models.ForeignKey(orm['configure.job'], null=False))
        ))
        db.create_unique('configure_command_jobs', ['command_id', 'job_id'])


    def backwards(self, orm):
        
        # Deleting model 'Command'
        db.delete_table('configure_command')

        # Removing M2M table for field jobs on 'Command'
        db.delete_table('configure_command_jobs')
