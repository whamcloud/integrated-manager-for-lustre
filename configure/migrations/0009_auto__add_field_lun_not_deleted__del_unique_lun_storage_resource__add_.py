...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Lun.not_deleted'
        db.add_column('configure_lun', 'not_deleted', self.gf('django.db.models.fields.NullBooleanField')(default=True, null=True, blank=True), keep_default=False)

        # Adding unique constraint on 'Lun', fields ['not_deleted', 'storage_resource']
        db.create_unique('configure_lun', ['not_deleted', 'storage_resource_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Lun', fields ['not_deleted', 'storage_resource']
        db.delete_unique('configure_lun', ['not_deleted', 'storage_resource_id'])

        # Deleting field 'Lun.not_deleted'
        db.delete_column('configure_lun', 'not_deleted')
