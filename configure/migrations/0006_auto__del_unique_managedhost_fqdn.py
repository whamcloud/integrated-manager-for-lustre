...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'ManagedHost', fields ['fqdn']
        db.delete_unique('configure_managedhost', ['fqdn'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'ManagedHost', fields ['fqdn']
        db.create_unique('configure_managedhost', ['fqdn'])
